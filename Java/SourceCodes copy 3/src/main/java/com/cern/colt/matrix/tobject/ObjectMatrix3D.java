...
public abstract class ObjectMatrix3D extends AbstractMatrix3D {
     ...
     */
    public Object aggregate(final com.cern.colt.function.tobject.ObjectObjectFunction aggr,
            final com.cern.colt.function.tobject.ObjectFunction f, final IntArrayList sliceList, final IntArrayList rowList,
     ...
     * @see com.cern.jet.math.tdouble.DoubleFunctions
     */
    public Object aggregate(final ObjectMatrix3D other, final com.cern.colt.function.tobject.ObjectObjectFunction aggr,
     ...
     */
    public ObjectMatrix3D assign(final com.cern.colt.function.tobject.ObjectProcedure cond,
            final com.cern.colt.function.tobject.ObjectFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (slices * rows * columns >= ConcurrencyUtils.getThreadsBeginN_3D())) {
            nthreads = Math.min(nthreads, slices);
     ...
     * 
     */
    public ObjectMatrix3D assign(final com.cern.colt.function.tobject.ObjectProcedure cond, final Object value) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (slices * rows * columns >= ConcurrencyUtils.getThreadsBeginN_3D())) {
            nthreads = Math.min(nthreads, slices);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see com.cern.jet.math.tdouble.DoubleFunctions
     */
    public ObjectMatrix3D assign(final com.cern.colt.function.tobject.ObjectFunction function) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (slices * rows * columns >= ConcurrencyUtils.getThreadsBeginN_3D())) {
            nthreads = Math.min(nthreads, slices);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see com.cern.jet.math.tdouble.DoubleFunctions
     */
    public ObjectMatrix3D assign(final ObjectMatrix3D y, final com.cern.colt.function.tobject.ObjectObjectFunction function) {
        checkShape(y);
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (slices * rows * columns >= ConcurrencyUtils.getThreadsBeginN_3D())) {
            nthreads = Math.min(nthreads, slices);
     ...
     * information, see
     * {@link com.cern.colt.matrix.tobject.algo.ObjectSorting#sort(ObjectMatrix3D,int,int)}
    ...
    public ObjectMatrix3D viewSorted(int row, int column) {
        return com.cern.colt.matrix.tobject.algo.ObjectSorting.mergeSort.sort(this, row, column);
    }
