...
import com.cern.colt.matrix.tdouble.impl.SparseDoubleMatrix1D;
 ...
 */
public class DoubleProperty extends com.cern.colt.PersistentObject {
    ...
    public boolean isOrthogonal(DoubleMatrix2D A) {
        checkSquare(A);
        return equals(A.zMult(A, null, 1, 0, false, true), com.cern.colt.matrix.tdouble.DoubleFactory2D.dense.identity(A
                .rows()));
    }
