 ...
 */
package com.cern.colt.matrix.tfloat.algo.decomposition;

import com.cern.colt.matrix.tfloat.FloatMatrix1D;
import com.cern.colt.matrix.tfloat.FloatMatrix2D;
import com.cern.colt.matrix.tfloat.algo.DenseFloatAlgebra;
import com.cern.colt.matrix.tfloat.algo.FloatProperty;
...
public class DenseFloatLUDecompositionQuick implements java.io.Serializable {
    ...
    public void decompose(FloatMatrix2D A) {
        ...
        com.cern.colt.list.tint.IntArrayList nonZeroIndexes = new com.cern.colt.list.tint.IntArrayList(); // sparsity
        FloatMatrix1D LUcolj = LU.viewColumn(0).like(); // blocked column j
        com.cern.jet.math.tfloat.FloatMult multFunction = com.cern.jet.math.tfloat.FloatMult.mult(0);
    ...
    public void solve(FloatMatrix2D B) {
        ...
        // transformations
        com.cern.jet.math.tfloat.FloatMult div = com.cern.jet.math.tfloat.FloatMult.div(0);
        com.cern.jet.math.tfloat.FloatPlusMultSecond minusMult = com.cern.jet.math.tfloat.FloatPlusMultSecond.minusMult(0);

        com.cern.colt.list.tint.IntArrayList nonZeroIndexes = new com.cern.colt.list.tint.IntArrayList(); // sparsity
        FloatMatrix1D Browk = com.cern.colt.matrix.tfloat.FloatFactory1D.dense.make(nx); // blocked
        // row
        // k
        ...
        for (int k = n - 1; k >= 0; k--) {
            ...
            // blocking
            if (Browk == null)
                Browk = com.cern.colt.matrix.tfloat.FloatFactory1D.dense.make(B.columns());
            Browk.assign(Brows[k]);
    ...
    public String toString() {
        ...
        buf.append("\npivot = ");
        try {
            buf.append(String.valueOf(new com.cern.colt.list.tint.IntArrayList(this.getPivot())));
        } catch (IllegalArgumentException exc) {
            buf.append(unknown + exc.getMessage());
        }
        ...
        buf.append("\n\ninverse(A) = ");
        FloatMatrix2D identity = com.cern.colt.matrix.tfloat.FloatFactory2D.dense.identity(LU.rows());
        try {
            this.solve(identity);
