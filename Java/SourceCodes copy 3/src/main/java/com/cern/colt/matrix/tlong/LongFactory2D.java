...
import com.cern.colt.matrix.tlong.impl.SparseLongMatrix2D;
import com.cern.colt.matrix.tlong.impl.SparseRCLongMatrix2D;
 ...
 */
public class LongFactory2D extends com.cern.colt.PersistentObject {
    /**
     * 
     */
    ...
    public void demo1() {
        ...
        LongMatrix2D[][] parts1 = { { null, make(2, 2, 1), null }, { make(4, 4, 2), null, make(4, 3, 3) },
                { null, make(2, 2, 4), null } };
        System.out.println("\n" + compose(parts1));
        // System.out.println("\n"+com.cern.colt.matrixpattern.Converting.toHTML(make(parts1).toString()));
        ...
        LongMatrix2D[][] parts3 = { { identity(3), null, }, { null, identity(3).viewColumnFlip() },
                { identity(3).viewRowFlip(), null } };
        System.out.println("\n" + compose(parts3));
        // System.out.println("\n"+com.cern.colt.matrixpattern.Converting.toHTML(make(parts3).toString()));
        ...
        LongMatrix2D[][] parts4 = { { A, _, A, _ }, { _, A, _, B } };
        System.out.println("\n" + compose(parts4));
        // System.out.println("\n"+com.cern.colt.matrixpattern.Converting.toHTML(make(parts4).toString()));
    ...
    public LongMatrix2D random(int rows, int columns) {
        return make(rows, columns).assign(LongFunctions.random());
    }
     ...
     * @see com.cern.jet.random.tdouble.sampling.DoubleRandomSamplingAssistant
     */
    ...
    public LongMatrix2D sample(LongMatrix2D matrix, int value, int nonZeroFraction) {
        ...
        com.cern.jet.random.tdouble.sampling.DoubleRandomSamplingAssistant sampler = new com.cern.jet.random.tdouble.sampling.DoubleRandomSamplingAssistant(
                n, size, new com.cern.jet.random.tdouble.engine.DoubleMersenneTwister());
        for (int i = 0; i < size; i++) {
