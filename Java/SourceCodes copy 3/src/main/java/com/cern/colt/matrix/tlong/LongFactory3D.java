...
import com.cern.colt.matrix.tlong.impl.DenseLongMatrix3D;
import com.cern.colt.matrix.tlong.impl.SparseLongMatrix3D;
 ...
 */
public class LongFactory3D extends com.cern.colt.PersistentObject {
    /**
     * 
     */
    ...
    public LongMatrix3D random(int slices, int rows, int columns) {
        return make(slices, rows, columns).assign(LongFunctions.random());
    }
}
