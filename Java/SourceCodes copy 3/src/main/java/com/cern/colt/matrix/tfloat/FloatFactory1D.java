 ...
 */
public class FloatFactory1D extends com.cern.colt.PersistentObject {
     ...
     * @return a new matrix.
     */
    public FloatMatrix1D make(com.cern.colt.list.tfloat.AbstractFloatList values) {
    ...
    public FloatMatrix1D random(int size) {
        return make(size).assign(FloatFunctions.random());
    }
    ...
    public FloatMatrix1D sample(int size, float value, float nonZeroFraction) {
        ...
        com.cern.jet.random.tfloat.sampling.FloatRandomSamplingAssistant sampler = new com.cern.jet.random.tfloat.sampling.FloatRandomSamplingAssistant(
                n, size, new com.cern.jet.random.tfloat.engine.FloatMersenneTwister());
        for (int i = size; --i >= 0;) {
     ...
     * @return a new list.
     */
    public com.cern.colt.list.tfloat.FloatArrayList toList(FloatMatrix1D values) {
        int size = (int) values.size();
        com.cern.colt.list.tfloat.FloatArrayList list = new com.cern.colt.list.tfloat.FloatArrayList(size);
        list.setSize(size);
        for (int i = size; --i >= 0;)
