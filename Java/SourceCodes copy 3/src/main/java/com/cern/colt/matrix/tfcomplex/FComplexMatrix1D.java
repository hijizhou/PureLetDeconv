...
public abstract class FComplexMatrix1D extends AbstractMatrix1D {
     ...
     * @see com.cern.jet.math.tfcomplex.FComplexFunctions
     */
    public FComplexMatrix1D assign(final com.cern.colt.function.tfcomplex.FComplexFComplexFunction f) {
        int size = (int) size();
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
     ...
     * @see com.cern.jet.math.tfcomplex.FComplexFunctions
     */
    public FComplexMatrix1D assign(final com.cern.colt.function.tfcomplex.FComplexProcedure cond,
            final com.cern.colt.function.tfcomplex.FComplexFComplexFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
     ...
     * 
     */
    public FComplexMatrix1D assign(final com.cern.colt.function.tfcomplex.FComplexProcedure cond, final float[] value) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see com.cern.jet.math.tfcomplex.FComplexFunctions
     */
    public FComplexMatrix1D assign(final com.cern.colt.function.tfcomplex.FComplexRealFunction f) {
        int size = (int) size();
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
    ...
    public boolean equals(Object obj) {
        ...
        return com.cern.colt.matrix.tfcomplex.algo.FComplexProperty.DEFAULT.equals(this, (FComplexMatrix1D) obj);
    }
     ...
     * @return the new view.
     */
    public FComplexMatrix1D viewSelection(com.cern.colt.function.tfcomplex.FComplexProcedure condition) {
        int size = (int) size();
