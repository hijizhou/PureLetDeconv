 ...
 * {@link com.cern.colt.map.tlong.OpenIntLongHashMap}, which is a compact and
 ...
 * @see com.cern.colt.map.tlong.OpenIntLongHashMap
...
public class SparseLongMatrix3D extends LongMatrix3D {
     ...
     * {@link com.cern.colt.map.tlong.OpenIntLongHashMap}.
     * 
     * @param slices
     *            the number of slices the matrix shall have.
     * @param rows
