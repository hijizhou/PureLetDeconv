...
import com.cern.colt.function.tfloat.LongFloatProcedure;
...
public abstract class AbstractLongFloatMap extends AbstractMap {
     ...
     *            value.
     */
    public void assign(final com.cern.colt.function.tfloat.FloatFunction function) {
        copy().forEachPair(new LongFloatProcedure() {
