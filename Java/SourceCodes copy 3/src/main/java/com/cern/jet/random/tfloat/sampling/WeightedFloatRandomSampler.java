 ...
 */
package com.cern.jet.random.tfloat.sampling;

import com.cern.colt.list.tboolean.BooleanArrayList;
import com.cern.jet.random.tfloat.FloatUniform;
 ...
 */
public class WeightedFloatRandomSampler extends com.cern.colt.PersistentObject {
    /**
     * 
     */
    ...
    public WeightedFloatRandomSampler(int weight, FloatRandomEngine randomGenerator) {
        if (randomGenerator == null)
            randomGenerator = com.cern.jet.random.tfloat.AbstractFloatDistribution.makeDefaultGenerator();
