 ...
 * A.forEachNonZero(new com.cern.colt.function.IntIntLongFunction() {
 ...
 * B.forEachNonZero(new com.cern.colt.function.IntIntLongFunction() {
 *     public long apply(int row, int column, long value) {
 ...
 * </table>
 * Method
 * {@link #assign(LongMatrix2D,com.cern.colt.function.tlong.LongLongFunction)} does
 * just that if you supply
 * {@link com.cern.jet.math.tlong.LongFunctions#plusMultSecond} as argument.
 * 
 * 
...
public class SparseCCLongMatrix2D extends WrapperLongMatrix2D {
    ...
    public LongMatrix2D assign(final com.cern.colt.function.tlong.LongFunction function) {
        if (function instanceof com.cern.jet.math.tlong.LongMult) { // x[i] = mult*x[i]
            final long alpha = ((com.cern.jet.math.tlong.LongMult) function).multiplicator;
            if (alpha == 1)
                return this;
            if (alpha == 0)
                return assign(0);
            ...
            forEachNonZero(new com.cern.colt.function.tlong.IntIntLongFunction() {
    ...
    public LongMatrix2D assign(LongMatrix2D source) {
        ...
        if (source instanceof SparseCCLongMatrix2D) {
            ...
            assign(0);
            source.forEachNonZero(new com.cern.colt.function.tlong.IntIntLongFunction() {
                public long apply(int i, int j, long value) {
                    setQuick(i, j, value);
                    return value;
                }
    ...
    public LongMatrix2D assign(final LongMatrix2D y, com.cern.colt.function.tlong.LongLongFunction function) {
        ...
        if ((y instanceof SparseCCLongMatrix2D) && (function == com.cern.jet.math.tlong.LongFunctions.plus)) { // x[i] = x[i] + y[i]
        ...
        if (function instanceof com.cern.jet.math.tlong.LongPlusMultFirst) { // x[i] = alpha*x[i] + y[i]
            final long alpha = ((com.cern.jet.math.tlong.LongPlusMultFirst) function).multiplicator;
            if (alpha == 0)
                return assign(y);
            y.forEachNonZero(new com.cern.colt.function.tlong.IntIntLongFunction() {
                public long apply(int i, int j, long value) {
        ...
        if (function == com.cern.jet.math.tlong.LongFunctions.mult) { // x[i] = x[i] * y[i]
        ...
        if (function == com.cern.jet.math.tlong.LongFunctions.div) { // x[i] = x[i] / y[i]
            final int[] rowIndexesA = rowIndexes;
            final int[] columnPointersA = columnPointers;
            final long[] valuesA = values;
    ...
    public LongMatrix2D zMult(LongMatrix2D B, LongMatrix2D C, final long alpha, long beta, final boolean transposeA,
        ...
        if ((B instanceof DenseLongMatrix2D) && (C instanceof DenseLongMatrix2D)) {
            ...
            if (alpha != 1.0) {
                C.assign(com.cern.jet.math.tlong.LongFunctions.mult(alpha));
            }
            ...
            Cp[n] = nz; /* finalize the last column of C */
            if (alpha != 1.0) {
                CC.assign(com.cern.jet.math.tlong.LongFunctions.mult(alpha));
            }
        } else {
            if (transposeB) {
                B = B.viewDice();
