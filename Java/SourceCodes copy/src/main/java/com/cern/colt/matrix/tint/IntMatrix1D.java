 ...
 */
package com.cern.colt.matrix.tint;
...
public abstract class IntMatrix1D extends AbstractMatrix1D {
     ...
     * @see com.cern.jet.math.tint.IntFunctions
     */
    public int aggregate(final com.cern.colt.function.tint.IntIntFunction aggr, final com.cern.colt.function.tint.IntFunction f) {
        if (size == 0)
     ...
     * @see com.cern.jet.math.tint.IntFunctions
     */
    public int aggregate(final com.cern.colt.function.tint.IntIntFunction aggr,
            final com.cern.colt.function.tint.IntFunction f, final IntArrayList indexList) {
        if (size() == 0)
            throw new IllegalArgumentException("size == 0");
     ...
     * @see com.cern.jet.math.tint.IntFunctions
     */
    public int aggregate(final IntMatrix1D other, final com.cern.colt.function.tint.IntIntFunction aggr,
            final com.cern.colt.function.tint.IntIntFunction f) {
        checkSize(other);
        if (size == 0)
            throw new IllegalArgumentException("size == 0");
     ...
     * @see com.cern.jet.math.tint.IntFunctions
     */
    public IntMatrix1D assign(final com.cern.colt.function.tint.IntFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see com.cern.jet.math.tint.IntFunctions
     */
    public IntMatrix1D assign(final com.cern.colt.function.tint.IntProcedure cond,
            final com.cern.colt.function.tint.IntFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
            Future<?>[] futures = new Future[nthreads];
     ...
     * 
     */
    public IntMatrix1D assign(final com.cern.colt.function.tint.IntProcedure cond, final int value) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see com.cern.jet.math.tint.IntFunctions
     */
    public IntMatrix1D assign(final IntMatrix1D y, final com.cern.colt.function.tint.IntIntFunction function) {
        checkSize(y);
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
     ...
     * @see com.cern.jet.math.tint.IntFunctions
     */
    public IntMatrix1D assign(IntMatrix1D y, com.cern.colt.function.tint.IntIntFunction function,
            IntArrayList nonZeroIndexes) {
        checkSize(y);
        int[] nonZeroElements = nonZeroIndexes.elements();

        // specialized for speed
        if (function == com.cern.jet.math.tint.IntFunctions.mult) { // x[i] = x[i] *
            // y[i]
            int j = 0;
        ...
        } else if (function instanceof com.cern.jet.math.tint.IntPlusMultSecond) {
            int multiplicator = ((com.cern.jet.math.tint.IntPlusMultSecond) function).multiplicator;
    ...
    public boolean equals(int value) {
        return com.cern.colt.matrix.tint.algo.IntProperty.DEFAULT.equals(this, value);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return com.cern.colt.matrix.tint.algo.IntProperty.DEFAULT.equals(this, (IntMatrix1D) obj);
    }
     ...
     * 
     * @see com.cern.colt.matrix.tint.algo.IntFormatter
     */

    public String toString() {
        return new com.cern.colt.matrix.tint.algo.IntFormatter().toString(this);
    }
     ...
     * @return the new view.
     */
    public IntMatrix1D viewSelection(com.cern.colt.function.tint.IntProcedure condition) {
     ...
     * information, see
     * {@link com.cern.colt.matrix.tint.algo.IntSorting#sort(IntMatrix1D)}. For more
     * advanced sorting functionality, see
     * {@link com.cern.colt.matrix.tint.algo.IntSorting}.
     * 
     * @return a new sorted vector (matrix) view.
     */
    public IntMatrix1D viewSorted() {
        return com.cern.colt.matrix.tint.algo.IntSorting.mergeSort.sort(this);
    }
    ...
    public int zSum() {
        if (size() == 0)
            return 0;
        return aggregate(com.cern.jet.math.tint.IntFunctions.plus, com.cern.jet.math.tint.IntFunctions.identity);
    }
}
