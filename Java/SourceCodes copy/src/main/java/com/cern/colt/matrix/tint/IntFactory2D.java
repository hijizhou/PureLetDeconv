...
import com.cern.colt.matrix.tint.impl.SparseIntMatrix2D;
import com.cern.colt.matrix.tint.impl.SparseRCIntMatrix2D;
 ...
 */
public class IntFactory2D extends com.cern.colt.PersistentObject {
    /**
     * 
     */
    ...
    public IntMatrix2D random(int rows, int columns) {
        return make(rows, columns).assign(IntFunctions.random());
    }
