 ...
 */
public class DoubleFactory1D extends com.cern.colt.PersistentObject {
     ...
     * @return a new matrix.
     */
    public DoubleMatrix1D make(com.cern.colt.list.tdouble.AbstractDoubleList values) {
    ...
    public DoubleMatrix1D random(int size) {
        return make(size).assign(DoubleFunctions.random());
    }
     ...
     * @return a new list.
     */
    public com.cern.colt.list.tdouble.DoubleArrayList toList(DoubleMatrix1D values) {
        int size = (int) values.size();
        com.cern.colt.list.tdouble.DoubleArrayList list = new com.cern.colt.list.tdouble.DoubleArrayList(size);
        list.setSize(size);
        for (int i = size; --i >= 0;)
