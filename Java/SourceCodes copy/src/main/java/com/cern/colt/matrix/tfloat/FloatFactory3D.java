...
import com.cern.colt.matrix.tfloat.impl.SparseFloatMatrix3D;
 ...
 */
public class FloatFactory3D extends com.cern.colt.PersistentObject {
    ...
    public FloatMatrix3D random(int slices, int rows, int columns) {
        return make(slices, rows, columns).assign(FloatFunctions.random());
    }
}
