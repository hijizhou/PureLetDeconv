...
public class SmpFloatBlas implements FloatBlas {
    ...
    public void assign(FloatMatrix2D A, final com.cern.colt.function.tfloat.FloatFunction function) {
        A.assign(function);
    }

    public void assign(FloatMatrix2D A, FloatMatrix2D B, final com.cern.colt.function.tfloat.FloatFloatFunction function) {
        A.assign(B, function);
    }
    ...
    public void dger(float alpha, FloatMatrix1D x, FloatMatrix1D y, FloatMatrix2D A) {
        com.cern.jet.math.tfloat.FloatPlusMultSecond fun = com.cern.jet.math.tfloat.FloatPlusMultSecond.plusMult(0);
        int rows = A.rows();
