 ...
 */
package com.cern.colt.list.tobject;

import com.cern.colt.function.tobject.ObjectProcedure;
...
public class ObjectArrayList extends AbstractList {
    ...
    public int binarySearchFromTo(Object key, int from, int to, java.util.Comparator comparator) {
        return com.cern.colt.Sorting.binarySearchFromTo(this.elements, key, from, to, comparator);
    }
    ...
    public void ensureCapacity(int minCapacity) {
        elements = com.cern.colt.Arrays.ensureCapacity(elements, minCapacity);
    }
    ...
    public void quickSortFromTo(int from, int to) {
        if (size == 0)
            return;
        checkRangeFromTo(from, to, size);
        com.cern.colt.Sorting.quickSort(elements, from, to + 1);
    }
    ...
    public void quickSortFromTo(int from, int to, java.util.Comparator c) {
        if (size == 0)
            return;
        checkRangeFromTo(from, to, size);
        com.cern.colt.Sorting.quickSort(elements, from, to + 1, c);
    }
    ...
    public void trimToSize() {
        elements = com.cern.colt.Arrays.trimToCapacity(elements, size());
    }
}
