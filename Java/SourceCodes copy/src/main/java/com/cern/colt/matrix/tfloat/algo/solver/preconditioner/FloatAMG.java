...
import com.cern.colt.matrix.tfloat.algo.decomposition.DenseFloatLUDecompositionQuick;
...
import com.cern.colt.matrix.tfloat.impl.SparseCCMFloatMatrix2D;
import com.cern.colt.matrix.tfloat.impl.SparseRCFloatMatrix2D;
import com.cern.colt.matrix.tfloat.impl.SparseRCMFloatMatrix2D;
    ...
    private static class Aggregator {
        ...
        private int[] findDiagonalindexes(SparseRCFloatMatrix2D A) {
            ...
            for (int i = 0; i < A.rows(); ++i) {
                diagind[i] = com.cern.colt.Sorting.binarySearchFromTo(colind, i, rowptr[i], rowptr[i + 1]);
                if (diagind[i] < 0)
