 ...
 * passed as format string, {@link Double#toString(double)} is used
...
public class DoubleFormatter extends AbstractFormatter {
    ...
    public static void demo1() {
        ...
        DoubleMatrix2D matrix = com.cern.colt.matrix.tdouble.DoubleFactory2D.dense.make(values);
    ...
    public static void demo3(int size, double value) {
        ...
        String s;
        StringBuffer buf;
        DoubleMatrix2D matrix = com.cern.colt.matrix.tdouble.DoubleFactory2D.dense.make(size, size, value);
    ...
    public static void demo5() {
        ...
        System.out.println(com.cern.colt.matrix.tdouble.DoubleFactory2D.dense.make(values));
        System.out.println(new DoubleFormatter("%G").toTitleString(com.cern.colt.matrix.tdouble.DoubleFactory2D.dense
    ...
    public static void demo6() {
        ...
        // System.out.println(com.cern.colt.matrix.DoubleFactory2D.dense.make(values));
        // System.out.println(new
        // Formatter().toSourceCode(com.cern.colt.matrix.DoubleFactory2D.dense.make(values)));
        System.out.println(new DoubleFormatter().toString(com.cern.colt.matrix.tdouble.DoubleFactory2D.dense.make(values)));
        System.out.println(new DoubleFormatter().toTitleString(com.cern.colt.matrix.tdouble.DoubleFactory2D.dense
                .make(values), rowNames, columnNames, "vendor", "density", "title"));
    }
    ...
    public static void demo7() {
        ...
        com.hep.aida.tdouble.bin.DoubleBinFunctions1D F = com.hep.aida.tdouble.bin.DoubleBinFunctions1D.functions;
        com.hep.aida.tdouble.bin.DoubleBinFunction1D[] aggr = { F.mean, F.rms, F.quantile(0.25), F.median,
                F.quantile(0.75), F.stdDev, F.min, F.max };
        String format = "%1.2G";
        System.out.println(new DoubleFormatter(format).toTitleString(com.cern.colt.matrix.tdouble.DoubleFactory2D.dense
    ...
    public String toTitleString(DoubleMatrix2D matrix, String[] rowNames, String[] columnNames, String rowAxisName,
            String columnAxisName, String title, com.hep.aida.tdouble.bin.DoubleBinFunction1D[] aggr) {
        if (matrix.size() == 0)
            return "Empty matrix";
    ...
    public String toTitleString(DoubleMatrix3D matrix, String[] sliceNames, String[] rowNames, String[] columnNames,
            ...
            com.hep.aida.tdouble.bin.DoubleBinFunction1D[] aggr) {
        if (matrix.size() == 0)
            return "Empty matrix";
        StringBuffer buf = new StringBuffer();
