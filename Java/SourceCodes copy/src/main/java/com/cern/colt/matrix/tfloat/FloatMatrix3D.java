...
public abstract class FloatMatrix3D extends AbstractMatrix3D {
     ...
     */
    public float aggregate(final com.cern.colt.function.tfloat.FloatFloatFunction aggr,
            final com.cern.colt.function.tfloat.FloatFunction f, final IntArrayList sliceList, final IntArrayList rowList,
     ...
     * @see FloatFunctions
     */
    public float aggregate(final FloatMatrix3D other, final com.cern.colt.function.tfloat.FloatFloatFunction aggr,
     ...
     * @see FloatFunctions
     */
    public FloatMatrix3D assign(final com.cern.colt.function.tfloat.FloatFunction function) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (slices * rows * columns >= ConcurrencyUtils.getThreadsBeginN_3D())) {
            nthreads = Math.min(nthreads, slices);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see FloatFunctions
     */
    public FloatMatrix3D assign(final com.cern.colt.function.tfloat.FloatProcedure cond,
            final com.cern.colt.function.tfloat.FloatFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (slices * rows * columns >= ConcurrencyUtils.getThreadsBeginN_3D())) {
            nthreads = Math.min(nthreads, slices);
     ...
     * 
     */
    public FloatMatrix3D assign(final com.cern.colt.function.tfloat.FloatProcedure cond, final float value) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (slices * rows * columns >= ConcurrencyUtils.getThreadsBeginN_3D())) {
            nthreads = Math.min(nthreads, slices);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see FloatFunctions
     */
    public FloatMatrix3D assign(final FloatMatrix3D y, final com.cern.colt.function.tfloat.FloatFloatFunction function) {
        checkShape(y);
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (slices * rows * columns >= ConcurrencyUtils.getThreadsBeginN_3D())) {
            nthreads = Math.min(nthreads, slices);
    ...
    public boolean equals(Object obj) {
        ...
        return com.cern.colt.matrix.tfloat.algo.FloatProperty.DEFAULT.equals(this, (FloatMatrix3D) obj);
    }
     ...
     * information, see
     * {@link com.cern.colt.matrix.tfloat.algo.FloatSorting#sort(FloatMatrix3D,int,int)}
    ...
    public FloatMatrix3D viewSorted(int row, int column) {
        return com.cern.colt.matrix.tfloat.algo.FloatSorting.mergeSort.sort(this, row, column);
    }
     ...
     * 
     * com.cern.colt.function.Float27Function f = new
     * com.cern.colt.function.Float27Function() {    public final
     ...
     *             .
     */
    public void zAssign27Neighbors(FloatMatrix3D B, com.cern.colt.function.tfloat.Float27Function function) {
        if (function == null)
