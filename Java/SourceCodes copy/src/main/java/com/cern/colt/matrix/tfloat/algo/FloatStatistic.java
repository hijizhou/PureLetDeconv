 ...
 */
package com.cern.colt.matrix.tfloat.algo;

import com.hep.aida.tfloat.bin.DynamicFloatBin1D;

import java.util.concurrent.Future;

import com.cern.colt.function.tfloat.FloatFloatFunction;
import com.cern.colt.matrix.tfloat.FloatFactory1D;
import com.cern.colt.matrix.tfloat.FloatFactory2D;
 ...
 * {@link com.hep.aida.tfloat.bin}, in particular
 * {@link DynamicFloatBin1D}.
 * <p>
 * Examples:
...
public class FloatStatistic extends Object {
    ...
    public interface VectorVectorFunction {
         ...
         */
        abstract public float apply(FloatMatrix1D x, FloatMatrix1D y);
    }
     ...
     * @see FloatFormatter
     * @see com.hep.aida.tfloat.bin.FloatBinFunction1D
     * @see com.hep.aida.tfloat.bin.FloatBinFunctions1D
     */
    public static FloatMatrix2D aggregate(FloatMatrix2D matrix, com.hep.aida.tfloat.bin.FloatBinFunction1D[] aggr,
            FloatMatrix2D result) {
        DynamicFloatBin1D bin = new DynamicFloatBin1D();
        float[] elements = new float[matrix.rows()];
        com.cern.colt.list.tfloat.FloatArrayList values = new com.cern.colt.list.tfloat.FloatArrayList(elements);
    ...
    public static FloatMatrix2D covariance(FloatMatrix2D matrix) {
        ...
        FloatMatrix2D covariance = new com.cern.colt.matrix.tfloat.impl.DenseFloatMatrix2D(columns, columns);
     ...
     */
    public static com.hep.aida.tfloat.FloatIHistogram2D cube(FloatMatrix1D x, FloatMatrix1D y, FloatMatrix1D weights) {
        if (x.size() != y.size() || y.size() != weights.size())
            throw new IllegalArgumentException("vectors must have same size");

        float epsilon = 1.0E-5f;
        com.cern.colt.list.tfloat.FloatArrayList distinct = new com.cern.colt.list.tfloat.FloatArrayList();
        float[] vals = new float[(int) x.size()];
        com.cern.colt.list.tfloat.FloatArrayList sorted = new com.cern.colt.list.tfloat.FloatArrayList(vals);

        // compute distinct values of x
        x.toArray(vals); // copy x into vals
        sorted.sort();
        com.cern.jet.stat.tfloat.FloatDescriptive.frequencies(sorted, distinct, null);
        ...
        distinct.trimToSize();
        com.hep.aida.tfloat.FloatIAxis xaxis = new com.hep.aida.tfloat.ref.FloatVariableAxis(distinct.elements());
        ...
        if (distinct.size() > 0)
            distinct.add(distinct.get(distinct.size() - 1) + epsilon);
        distinct.trimToSize();
        com.hep.aida.tfloat.FloatIAxis yaxis = new com.hep.aida.tfloat.ref.FloatVariableAxis(distinct.elements());

        com.hep.aida.tfloat.FloatIHistogram2D histo = new com.hep.aida.tfloat.ref.FloatHistogram2D("Cube", xaxis, yaxis);
     ...
     *             .
     */
    public static com.hep.aida.tfloat.FloatIHistogram3D cube(FloatMatrix1D x, FloatMatrix1D y, FloatMatrix1D z,
        ...
        if (distinct.size() > 0)
            distinct.add(distinct.get(distinct.size() - 1) + epsilon);
        distinct.trimToSize();
        com.hep.aida.tfloat.FloatIAxis zaxis = new com.hep.aida.tfloat.ref.FloatVariableAxis(distinct.elements());

        com.hep.aida.tfloat.FloatIHistogram3D histo = new com.hep.aida.tfloat.ref.FloatHistogram3D("Cube", xaxis, yaxis, zaxis);
    ...
    public static FloatMatrix2D distance(FloatMatrix2D matrix, VectorVectorFunction distanceFunction) {
        int columns = matrix.columns();
        FloatMatrix2D distance = new com.cern.colt.matrix.tfloat.impl.DenseFloatMatrix2D(columns, columns);
     ...
     */
    public static com.hep.aida.tfloat.FloatIHistogram1D histogram(com.hep.aida.tfloat.FloatIHistogram1D histo,
     ...
     * @return <tt>histo</tt> (for convenience only).
     */
    public static com.hep.aida.tfloat.FloatIHistogram1D histogram(final com.hep.aida.tfloat.FloatIHistogram1D histo,
     ...
     */
    public static com.hep.aida.tfloat.FloatIHistogram2D histogram(com.hep.aida.tfloat.FloatIHistogram2D histo, FloatMatrix1D x,
            FloatMatrix1D y) {
        if (x.size() != y.size())
            throw new IllegalArgumentException("vectors must have same size");
     ...
     *             .
     */
    public static com.hep.aida.tfloat.FloatIHistogram3D histogram(com.hep.aida.tfloat.FloatIHistogram3D histo, FloatMatrix1D x,
     ...
     *             .
     * @see com.cern.jet.random.tfloat.sampling.FloatRandomSampler
     */
    public static FloatMatrix1D viewSample(FloatMatrix1D matrix, float fraction, FloatRandomEngine randomGenerator) {
        ...
        if (randomGenerator == null)
            randomGenerator = new com.cern.jet.random.tfloat.engine.FloatMersenneTwister((int) System.currentTimeMillis());
        ...
        com.cern.jet.random.tfloat.sampling.FloatRandomSampler.sample(n, N, n, 0, selected, 0, randomGenerator);
