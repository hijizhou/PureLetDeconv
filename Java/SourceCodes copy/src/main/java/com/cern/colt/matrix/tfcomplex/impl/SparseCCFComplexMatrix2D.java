...
public class SparseCCFComplexMatrix2D extends WrapperFComplexMatrix2D {
    ...
    public FComplexMatrix2D assign(final com.cern.colt.function.tfcomplex.FComplexFComplexFunction function) {
        if (function instanceof com.cern.jet.math.tfcomplex.FComplexMult) { // x[i] = mult*x[i]
            final float[] alpha = ((com.cern.jet.math.tfcomplex.FComplexMult) function).multiplicator;
            ...
            forEachNonZero(new com.cern.colt.function.tfcomplex.IntIntFComplexFunction() {
    ...
    public FComplexMatrix2D assign(FComplexMatrix2D source) {
        ...
        if (source instanceof SparseCCFComplexMatrix2D) {
            ...
            assign(0, 0);
            source.forEachNonZero(new com.cern.colt.function.tfcomplex.IntIntFComplexFunction() {
                public float[] apply(int i, int j, float[] value) {
                    setQuick(i, j, value);
                    return value;
                }
    ...
    public FComplexMatrix2D assign(final FComplexMatrix2D y,
        ...
        if ((y instanceof SparseCCFComplexMatrix2D) && (function == com.cern.jet.math.tfcomplex.FComplexFunctions.plus)) { // x[i] = x[i] + y[i]
        ...
        if (function instanceof com.cern.jet.math.tfcomplex.FComplexPlusMultSecond) { // x[i] = x[i] + alpha*y[i]
        ...
        if (function instanceof com.cern.jet.math.tfcomplex.FComplexPlusMultFirst) { // x[i] = alpha*x[i] + y[i]
            final float[] alpha = ((com.cern.jet.math.tfcomplex.FComplexPlusMultFirst) function).multiplicator;
            if (alpha[0] == 0 && alpha[1] == 0)
                return assign(y);
            y.forEachNonZero(new com.cern.colt.function.tfcomplex.IntIntFComplexFunction() {
                public float[] apply(int i, int j, float[] value) {
        ...
        if (function == com.cern.jet.math.tfcomplex.FComplexFunctions.mult) { // x[i] = x[i] * y[i]
        ...
        if (function == com.cern.jet.math.tfcomplex.FComplexFunctions.div) { // x[i] = x[i] / y[i]
            final int[] rowIndexesA = rowIndexes;
            final int[] columnPointersA = columnPointers;
            final float[] valuesA = values;
    ...
    public FComplexMatrix2D forEachNonZero(final com.cern.colt.function.tfcomplex.IntIntFComplexFunction function) {
        final int[] rowIndexesA = rowIndexes;
        final int[] columnPointersA = columnPointers;
        final float[] valuesA = values;
        float[] valA = new float[2];
    ...
    public FComplexMatrix1D zMult(FComplexMatrix1D y, FComplexMatrix1D z, final float[] alpha, final float[] beta,
        ...
        if (!transposeA) {
            if ((!ignore) && !(beta[0] == 1 && beta[1] == 0)) {
                z.assign(com.cern.jet.math.tfcomplex.FComplexFunctions.mult(beta));
            }
    ...
    public FComplexMatrix2D zMult(FComplexMatrix2D B, FComplexMatrix2D C, final float[] alpha, float[] beta,
        ...
        if (!ignore && !(beta[0] == 1 && beta[1] == 0)) {
            C.assign(com.cern.jet.math.tfcomplex.FComplexFunctions.mult(beta));
        }
        ...
        if ((B instanceof DenseFComplexMatrix2D) && (C instanceof DenseFComplexMatrix2D)) {
            ...
            if (!(alpha[0] == 1.0 && alpha[1] == 0)) {
                C.assign(com.cern.jet.math.tfcomplex.FComplexFunctions.mult(alpha));
            }
            ...
            Cp[n] = nz; /* finalize the last column of C */
            if (!(alpha[0] == 1.0 && alpha[1] == 0)) {
                CC.assign(com.cern.jet.math.tfcomplex.FComplexFunctions.mult(alpha));
            }
        } else {
            if (transposeB) {
            ...
            final com.cern.jet.math.tfcomplex.FComplexPlusMultSecond fun = com.cern.jet.math.tfcomplex.FComplexPlusMultSecond
