package com.hep.aida.tfloat.ref;

import com.hep.aida.tfloat.FloatIAxis;
import com.hep.aida.tfloat.FloatIHistogram1D;
import com.hep.aida.tfloat.FloatIHistogram2D;
import com.hep.aida.tfloat.FloatIHistogram3D;
...
public class FloatConverter {
    ...
    String form(com.cern.colt.matrix.Former formatter, float value) {
    ...
    public String toString(FloatIHistogram1D h) {
        ...
        com.hep.aida.tfloat.bin.FloatBinFunction1D[] aggr = null; // {com.hep.aida.bin.BinFunctions1D.sum};
        String format = "%G";
        // String format = "%1.2G";
        ...
        com.cern.colt.matrix.tfloat.FloatMatrix2D heights = new com.cern.colt.matrix.tfloat.impl.DenseFloatMatrix2D(1, h
                .xAxis().bins());
        heights.viewRow(0).assign(toArrayHeights(h));
        // com.cern.colt.matrix.FloatMatrix2D errors = new
        // com.cern.colt.matrix.impl.DenseFloatMatrix2D(1,h.xAxis().bins());
        ...
        return title
                ...
                + "Heights:"
                + sep
                + new com.cern.colt.matrix.tfloat.algo.FloatFormatter().toTitleString(heights, yEdges, xEdges, rowAxisName,
                        columnAxisName, null, aggr);
        /*
         * + sep + "Errors:" + sep + new
         * com.cern.colt.matrix.floatalgo.Formatter().toTitleString(
    ...
    public String toString(FloatIHistogram2D h) {
        ...
        com.hep.aida.tfloat.bin.FloatBinFunction1D[] aggr = { com.hep.aida.tfloat.bin.FloatBinFunctions1D.sum };
        String format = "%G";
        // String format = "%1.2G";
        ...
        com.cern.colt.matrix.tfloat.FloatMatrix2D heights = new com.cern.colt.matrix.tfloat.impl.DenseFloatMatrix2D(
                toArrayHeights(h));
        ...
        // com.cern.colt.matrix.FloatMatrix2D errors = new
        // com.cern.colt.matrix.impl.DenseFloatMatrix2D(toArrayErrors(h));
    ...
    public String toString(FloatIHistogram3D h) {
        ...
        com.cern.colt.matrix.tfloat.FloatMatrix3D heights = new com.cern.colt.matrix.tfloat.impl.DenseFloatMatrix3D(
                toArrayHeights(h));
        ...
        return title
                ...
                + "Heights:"
                + sep
                + new com.cern.colt.matrix.tfloat.algo.FloatFormatter().toTitleString(heights, zEdges, yEdges, xEdges,
