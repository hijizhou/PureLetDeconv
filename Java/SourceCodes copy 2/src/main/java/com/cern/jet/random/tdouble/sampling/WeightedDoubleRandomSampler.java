 ...
 */
package com.cern.jet.random.tdouble.sampling;

import com.cern.colt.list.tboolean.BooleanArrayList;
import com.cern.jet.random.tdouble.DoubleUniform;
 ...
 */
public class WeightedDoubleRandomSampler extends com.cern.colt.PersistentObject {
    /**
     * 
     */
    ...
    public WeightedDoubleRandomSampler(int weight, DoubleRandomEngine randomGenerator) {
        if (randomGenerator == null)
            randomGenerator = com.cern.jet.random.tdouble.AbstractDoubleDistribution.makeDefaultGenerator();
    ...
    public static void test(int weight, int size) {
        ...
        com.cern.colt.list.tint.IntArrayList sample = new com.cern.colt.list.tint.IntArrayList();
