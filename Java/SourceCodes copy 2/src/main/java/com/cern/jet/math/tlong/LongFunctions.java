...
import com.cern.colt.function.tlong.LongLongProcedure;
import com.cern.colt.function.tlong.LongProcedure;
import com.cern.jet.math.tdouble.DoubleArithmetic;
...
public class LongFunctions extends Object {
    ...
    public static LongFunction random() {
        return new com.cern.jet.random.tdouble.engine.DoubleMersenneTwister(new java.util.Date());
    }
