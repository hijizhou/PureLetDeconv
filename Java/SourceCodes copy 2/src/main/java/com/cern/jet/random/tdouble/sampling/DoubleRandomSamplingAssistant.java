 ...
 */
public class DoubleRandomSamplingAssistant extends com.cern.colt.PersistentObject {
    /**
     * 
     */
    ...
    public static void test(long n, long N) {
        ...
        com.cern.colt.list.tlong.LongArrayList sample = new com.cern.colt.list.tlong.LongArrayList((int) n);
