...
import com.cern.colt.matrix.tint.impl.DenseIntMatrix3D;
import com.cern.colt.matrix.tint.impl.SparseIntMatrix3D;
 ...
 */
public class IntFactory3D extends com.cern.colt.PersistentObject {
    /**
     * 
     */
    ...
    public IntMatrix3D random(int slices, int rows, int columns) {
        return make(slices, rows, columns).assign(IntFunctions.random());
    }
}
