 ...
 */
package com.cern.colt.matrix.tint.impl;
 ...
 * A.forEachNonZero(new com.cern.colt.function.IntIntIntFunction() {
 ...
 * B.forEachNonZero(new com.cern.colt.function.IntIntIntFunction() {
 *     public int apply(int row, int column, int value) {
 ...
 * </td>
 * </table>
 * Method {@link #assign(IntMatrix2D,com.cern.colt.function.tint.IntIntFunction)}
 * does just that if you supply
 * {@link com.cern.jet.math.tint.IntFunctions#plusMultSecond} as argument.
 * 
 * 
...
public class SparseCCIntMatrix2D extends WrapperIntMatrix2D {
    ...
    public IntMatrix2D assign(final com.cern.colt.function.tint.IntFunction function) {
        if (function instanceof com.cern.jet.math.tint.IntMult) { // x[i] = mult*x[i]
            final int alpha = ((com.cern.jet.math.tint.IntMult) function).multiplicator;
            if (alpha == 1)
                return this;
            if (alpha == 0)
                return assign(0);
            ...
            forEachNonZero(new com.cern.colt.function.tint.IntIntIntFunction() {
    ...
    public IntMatrix2D assign(IntMatrix2D source) {
        ...
        if (source instanceof SparseCCIntMatrix2D) {
            ...
            assign(0);
            source.forEachNonZero(new com.cern.colt.function.tint.IntIntIntFunction() {
                public int apply(int i, int j, int value) {
                    setQuick(i, j, value);
                    return value;
                }
    ...
    public IntMatrix2D assign(final IntMatrix2D y, com.cern.colt.function.tint.IntIntFunction function) {
        checkShape(y);

        if ((y instanceof SparseCCIntMatrix2D) && (function == com.cern.jet.math.tint.IntFunctions.plus)) { // x[i] = x[i] + y[i]
        ...
        if (function instanceof com.cern.jet.math.tint.IntPlusMultSecond) { // x[i] = x[i] + alpha*y[i]
            final int alpha = ((com.cern.jet.math.tint.IntPlusMultSecond) function).multiplicator;
            if (alpha == 0)
                return this; // nothing to do
            y.forEachNonZero(new com.cern.colt.function.tint.IntIntIntFunction() {
                public int apply(int i, int j, int value) {
        ...
        if (function instanceof com.cern.jet.math.tint.IntPlusMultFirst) { // x[i] = alpha*x[i] + y[i]
            final int alpha = ((com.cern.jet.math.tint.IntPlusMultFirst) function).multiplicator;
            if (alpha == 0)
                return assign(y);
            y.forEachNonZero(new com.cern.colt.function.tint.IntIntIntFunction() {
                public int apply(int i, int j, int value) {
        ...
        if (function == com.cern.jet.math.tint.IntFunctions.mult) { // x[i] = x[i] * y[i]
        ...
        if (function == com.cern.jet.math.tint.IntFunctions.div) { // x[i] = x[i] / y[i]
            final int[] rowIndexesA = rowIndexes;
            final int[] columnPointersA = columnPointers;
            final int[] valuesA = values;
    ...
    public IntMatrix2D forEachNonZero(final com.cern.colt.function.tint.IntIntIntFunction function) {
        final int[] rowIndexesA = rowIndexes;
        final int[] columnPointersA = columnPointers;
        final int[] valuesA = values;
    ...
    public IntMatrix1D zMult(IntMatrix1D y, IntMatrix1D z, final int alpha, final int beta, final boolean transposeA) {
        ...
        if (!transposeA) {
            if ((!ignore) && (beta != 1)) {
                z.assign(com.cern.jet.math.tint.IntFunctions.mult(beta));
            }
    ...
    public IntMatrix2D zMult(IntMatrix2D B, IntMatrix2D C, final int alpha, int beta, final boolean transposeA,
        ...
        if (!ignore && beta != 1.0) {
            C.assign(com.cern.jet.math.tint.IntFunctions.mult(beta));
        }
        ...
        if ((B instanceof DenseIntMatrix2D) && (C instanceof DenseIntMatrix2D)) {
            ...
            if (alpha != 1.0) {
                C.assign(com.cern.jet.math.tint.IntFunctions.mult(alpha));
            }
            ...
            Cp[n] = nz; /* finalize the last column of C */
            if (alpha != 1.0) {
                CC.assign(com.cern.jet.math.tint.IntFunctions.mult(alpha));
            }
        } else {
            if (transposeB) {
                B = B.viewDice();
            ...
            final com.cern.jet.math.tint.IntPlusMultSecond fun = com.cern.jet.math.tint.IntPlusMultSecond.plusMult(0);
