 ...
 */
package com.cern.colt.map.tdouble;

import com.cern.colt.function.tdouble.DoubleIntProcedure;
...
import com.cern.colt.map.AbstractMap;
...
public abstract class AbstractDoubleIntMap extends AbstractMap {
    ...
    public void pairsSortedByKey(final DoubleArrayList keyList, final IntArrayList valueList) {
         ...
         * valueList.elements(); com.cern.colt.Swapper swapper = new
         * com.cern.colt.Swapper() { public void swap(int a, int b) { int t1; double
         * t2; t1 = v[a]; v[a] = v[b]; v[b] = t1; t2 = k[a]; k[a] = k[b]; k[b] =
         * t2; } };
         * 
         * com.cern.colt.function.IntComparator comp = new
         * com.cern.colt.function.IntComparator() { public int compare(int a, int b) {
         * return k[a]<k[b] ? -1 : k[a]==k[b] ? 0 : 1; } };
         * com.cern.colt.MultiSorting.sort(0,keyList.size(),comp,swapper);
         */
    ...
    public void pairsSortedByValue(final DoubleArrayList keyList, final IntArrayList valueList) {
        ...
        // com.cern.colt.map.OpenDoubleIntHashMap.hashCollisions = 0;
        com.cern.colt.GenericSorting.quickSort(0, keyList.size(), comp, swapper);
        // System.out.println("collisions="+com.cern.colt.map.OpenDoubleIntHashMap.hashCollisions);
    }
