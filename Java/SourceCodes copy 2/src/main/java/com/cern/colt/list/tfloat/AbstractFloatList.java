 ...
 */
package com.cern.colt.list.tfloat;

import com.cern.colt.function.tfloat.FloatComparator;
 ...
 * picture.
 */
public abstract class AbstractFloatList extends AbstractList implements com.cern.colt.buffer.tfloat.FloatBufferConsumer {
    /**
     * 
     */
    ...
    public void quickSortFromTo(int from, int to) {
        ...
        //        com.cern.colt.Sorting.parallelQuickSort(myElements, from, to + 1, new FloatComparator() {
    ...
    public void shuffleFromTo(int from, int to) {
        ...
        com.cern.jet.random.tfloat.FloatUniform gen = new com.cern.jet.random.tfloat.FloatUniform(AbstractFloatDistribution
