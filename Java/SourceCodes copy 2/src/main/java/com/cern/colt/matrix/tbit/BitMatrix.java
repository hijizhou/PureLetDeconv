 ...
 */
package com.cern.colt.matrix.tbit;
 ...
 */
public class BitMatrix extends com.cern.colt.PersistentObject {
     ...
     */
    public boolean forEachCoordinateInState(boolean state, final com.cern.colt.function.tint.IntIntProcedure procedure) {
        /*
         ...
         * com.cern.colt.function.IntFunction() { public boolean apply(int index) {
