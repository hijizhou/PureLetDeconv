...
public class DenseDoubleLUDecompositionQuick implements java.io.Serializable {
    ...
    public void decompose(DoubleMatrix2D A) {
        ...
        com.cern.jet.math.tdouble.DoubleMult multFunction = com.cern.jet.math.tdouble.DoubleMult.mult(0);
    ...
    public void solve(DoubleMatrix2D B) {
        ...
        // transformations
        com.cern.jet.math.tdouble.DoubleMult div = com.cern.jet.math.tdouble.DoubleMult.div(0);
        com.cern.jet.math.tdouble.DoublePlusMultSecond minusMult = com.cern.jet.math.tdouble.DoublePlusMultSecond.minusMult(0);

        com.cern.colt.list.tint.IntArrayList nonZeroIndexes = new com.cern.colt.list.tint.IntArrayList(); // sparsity
        DoubleMatrix1D Browk = com.cern.colt.matrix.tdouble.DoubleFactory1D.dense.make(nx); // blocked
        // row
        // k
        ...
        for (int k = n - 1; k >= 0; k--) {
            ...
            // blocking
            if (Browk == null)
                Browk = com.cern.colt.matrix.tdouble.DoubleFactory1D.dense.make(B.columns());
            Browk.assign(Brows[k]);
    ...
    public String toString() {
        ...
        buf.append("\n\ninverse(A) = ");
        DoubleMatrix2D identity = com.cern.colt.matrix.tdouble.DoubleFactory2D.dense.identity(LU.rows());
        try {
            this.solve(identity);
