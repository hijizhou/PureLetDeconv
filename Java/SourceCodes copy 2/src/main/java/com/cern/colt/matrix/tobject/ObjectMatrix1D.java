...
public abstract class ObjectMatrix1D extends AbstractMatrix1D {
     ...
     */
    public Object aggregate(final com.cern.colt.function.tobject.ObjectObjectFunction aggr,
            final com.cern.colt.function.tobject.ObjectFunction f, final IntArrayList indexList) {
        if (size() == 0)
     ...
     */
    public Object aggregate(final ObjectMatrix1D other, final com.cern.colt.function.tobject.ObjectObjectFunction aggr,
     ...
     */
    public ObjectMatrix1D assign(final com.cern.colt.function.tobject.ObjectFunction function) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see com.cern.jet.math.tdouble.DoubleFunctions
     */
    public ObjectMatrix1D assign(final ObjectMatrix1D y, final com.cern.colt.function.tobject.ObjectObjectFunction function) {
        checkSize(y);
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
     ...
     * @return the new view.
     */
    public ObjectMatrix1D viewSelection(com.cern.colt.function.tobject.ObjectProcedure condition) {
     ...
     * information, see
     * {@link com.cern.colt.matrix.tobject.algo.ObjectSorting#sort(ObjectMatrix1D)}.
    ...
    public ObjectMatrix1D viewSorted() {
        return com.cern.colt.matrix.tobject.algo.ObjectSorting.mergeSort.sort(this);
    }
