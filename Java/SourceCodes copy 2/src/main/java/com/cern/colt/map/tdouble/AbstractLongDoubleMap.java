...
import com.cern.colt.function.tdouble.LongDoubleProcedure;
...
public abstract class AbstractLongDoubleMap extends AbstractMap {
     ...
     *            value.
     */
    public void assign(final com.cern.colt.function.tdouble.DoubleFunction function) {
        copy().forEachPair(new LongDoubleProcedure() {
