 ...
 */
package com.cern.colt.matrix.tdouble.impl;

import java.util.Arrays;
import java.util.concurrent.Future;

import com.cern.colt.list.tdouble.DoubleArrayList;
...
import com.edu.emory.mathcs.csparsej.tdouble.Dcs_add;
import com.edu.emory.mathcs.csparsej.tdouble.Dcs_cumsum;
import com.edu.emory.mathcs.csparsej.tdouble.Dcs_dropzeros;
import com.edu.emory.mathcs.csparsej.tdouble.Dcs_dupl;
import com.edu.emory.mathcs.csparsej.tdouble.Dcs_multiply;
import com.edu.emory.mathcs.csparsej.tdouble.Dcs_transpose;
import com.edu.emory.mathcs.csparsej.tdouble.Dcs_util;
 ...
 * A.forEachNonZero(new com.cern.colt.function.IntIntDoubleFunction() {
 ...
 * B.forEachNonZero(new com.cern.colt.function.IntIntDoubleFunction() {
 *     public double apply(int row, int column, double value) {
 ...
 * </table>
 * Method
 * {@link #assign(DoubleMatrix2D,com.cern.colt.function.tdouble.DoubleDoubleFunction)}
 * does just that if you supply
 * {@link com.cern.jet.math.tdouble.DoubleFunctions#plusMultSecond} as argument.
 * 
 * 
...
public class SparseCCDoubleMatrix2D extends WrapperDoubleMatrix2D {
    ...
    public DoubleMatrix2D assign(final com.cern.colt.function.tdouble.DoubleFunction function) {
        if (function instanceof com.cern.jet.math.tdouble.DoubleMult) { // x[i] = mult*x[i]
            final double alpha = ((com.cern.jet.math.tdouble.DoubleMult) function).multiplicator;
            if (alpha == 1)
                return this;
            if (alpha == 0)
                return assign(0);
            ...
            forEachNonZero(new com.cern.colt.function.tdouble.IntIntDoubleFunction() {
    ...
    public DoubleMatrix2D assign(DoubleMatrix2D source) {
        ...
        if (source instanceof SparseCCDoubleMatrix2D) {
            ...
            assign(0);
            source.forEachNonZero(new com.cern.colt.function.tdouble.IntIntDoubleFunction() {
                public double apply(int i, int j, double value) {
                    setQuick(i, j, value);
                    return value;
                }
    ...
    public DoubleMatrix2D assign(final DoubleMatrix2D y, com.cern.colt.function.tdouble.DoubleDoubleFunction function) {
        checkShape(y);

        if ((y instanceof SparseCCDoubleMatrix2D) && (function == com.cern.jet.math.tdouble.DoubleFunctions.plus)) { // x[i] = x[i] + y[i]
            SparseCCDoubleMatrix2D yy = (SparseCCDoubleMatrix2D) y;
            dcs = Dcs_add.cs_add(dcs, yy.dcs, 1, 1);
            return this;
        }

        if (function instanceof com.cern.jet.math.tdouble.DoublePlusMultSecond) { // x[i] = x[i] + alpha*y[i]
            final double alpha = ((com.cern.jet.math.tdouble.DoublePlusMultSecond) function).multiplicator;
            if (alpha == 0)
                return this; // nothing to do
            y.forEachNonZero(new com.cern.colt.function.tdouble.IntIntDoubleFunction() {
                public double apply(int i, int j, double value) {
        ...
        if (function instanceof com.cern.jet.math.tdouble.DoublePlusMultFirst) { // x[i] = alpha*x[i] + y[i]
            final double alpha = ((com.cern.jet.math.tdouble.DoublePlusMultFirst) function).multiplicator;
            if (alpha == 0)
                return assign(y);
            y.forEachNonZero(new com.cern.colt.function.tdouble.IntIntDoubleFunction() {
                public double apply(int i, int j, double value) {
        ...
        if (function == com.cern.jet.math.tdouble.DoubleFunctions.mult) { // x[i] = x[i] * y[i]
        ...
        if (function == com.cern.jet.math.tdouble.DoubleFunctions.div) { // x[i] = x[i] / y[i]
            final int[] rowIndexesA = dcs.i;
            final int[] columnPointersA = dcs.p;
            final double[] valuesA = dcs.x;
    ...
    public DoubleMatrix2D forEachNonZero(final com.cern.colt.function.tdouble.IntIntDoubleFunction function) {
        final int[] rowIndexesA = dcs.i;
        final int[] columnPointersA = dcs.p;
        final double[] valuesA = dcs.x;
    ...
    public synchronized double getQuick(int row, int column) {
        //        int k = com.cern.colt.Sorting.binarySearchFromTo(dcs.i, row, dcs.p[column], dcs.p[column + 1] - 1);
    ...
    public DoubleMatrix1D zMult(DoubleMatrix1D y, DoubleMatrix1D z, final double alpha, final double beta,
        ...
        if (!transposeA) {
            if ((!ignore) && (beta / alpha != 1.0)) {
                z.assign(com.cern.jet.math.tdouble.DoubleFunctions.mult(beta / alpha));
            }
            ...
            if (alpha != 1.0) {
                z.assign(com.cern.jet.math.tdouble.DoubleFunctions.mult(alpha));
            }
        } else {
            if ((nthreads > 1) && (cardinality() >= ConcurrencyUtils.getThreadsBeginN_2D())) {
                Future<?>[] futures = new Future[nthreads];
    ...
    public DoubleMatrix2D zMult(DoubleMatrix2D B, DoubleMatrix2D C, final double alpha, double beta,
        ...
        if (!ignore && beta != 1.0) {
            C.assign(com.cern.jet.math.tdouble.DoubleFunctions.mult(beta));
        }
        ...
        if ((B instanceof DenseDoubleMatrix2D) && (C instanceof DenseDoubleMatrix2D)) {
            ...
            if (alpha != 1.0) {
                C.assign(com.cern.jet.math.tdouble.DoubleFunctions.mult(alpha));
            }
            ...
            if (alpha != 1.0) {
                CC.assign(com.cern.jet.math.tdouble.DoubleFunctions.mult(alpha));
            }
        } else {
            if (transposeB) {
                B = B.viewDice();
            ...
            final com.cern.jet.math.tdouble.DoublePlusMultSecond fun = com.cern.jet.math.tdouble.DoublePlusMultSecond
                    .plusMult(0);
