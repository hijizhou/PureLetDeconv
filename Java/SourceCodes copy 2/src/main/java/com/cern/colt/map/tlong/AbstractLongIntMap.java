...
import com.cern.colt.function.tlong.LongIntProcedure;
...
public abstract class AbstractLongIntMap extends AbstractMap {
     ...
     *            value.
     */
    public void assign(final com.cern.colt.function.tint.IntFunction function) {
        copy().forEachPair(new LongIntProcedure() {
