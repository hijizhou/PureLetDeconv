 ...
 */
package com.cern.colt.matrix.tobject;
...
import com.cern.colt.list.tobject.ObjectArrayList;
...
public abstract class ObjectMatrix2D extends AbstractMatrix2D {
     ...
     */
    public Object aggregate(final com.cern.colt.function.tobject.ObjectObjectFunction aggr,
            final com.cern.colt.function.tobject.ObjectFunction f) {
        if (size() == 0)
            return null;
        Object a = 0;
     ...
     */
    public Object aggregate(final com.cern.colt.function.tobject.ObjectObjectFunction aggr,
            final com.cern.colt.function.tobject.ObjectFunction f, final com.cern.colt.function.tobject.ObjectProcedure cond) {
        if (size() == 0)
     ...
     */
    public Object aggregate(final com.cern.colt.function.tobject.ObjectObjectFunction aggr,
            final com.cern.colt.function.tobject.ObjectFunction f, final IntArrayList rowList, final IntArrayList columnList) {
        if (size() == 0)
            throw new IllegalArgumentException("size == 0");
     ...
     * @see com.cern.jet.math.tdouble.DoubleFunctions
     */
    public Object aggregate(final ObjectMatrix2D other, final com.cern.colt.function.tobject.ObjectObjectFunction aggr,
            final com.cern.colt.function.tobject.ObjectObjectFunction f) {
        checkShape(other);
        if (size() == 0)
            return null;
        Object a = null;
     ...
     * @see com.cern.jet.math.tdouble.DoubleFunctions
     */
    public ObjectMatrix2D assign(final com.cern.colt.function.tobject.ObjectFunction function) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (rows * columns >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @return <tt>this</tt> (for convenience only).
     */
    public ObjectMatrix2D assign(final com.cern.colt.function.tobject.ObjectProcedure cond,
            final com.cern.colt.function.tobject.ObjectFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (rows * columns >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
     ...
     * 
     */
    public ObjectMatrix2D assign(final com.cern.colt.function.tobject.ObjectProcedure cond, final Object value) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (rows * columns >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see com.cern.jet.math.tdouble.DoubleFunctions
     */
    public ObjectMatrix2D assign(final ObjectMatrix2D y, final com.cern.colt.function.tobject.ObjectObjectFunction function) {
        checkShape(y);
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (rows * columns >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
     ...
     * @return <tt>this</tt> (for convenience only).
     */
    public ObjectMatrix2D forEachNonZero(final com.cern.colt.function.tobject.IntIntObjectFunction function) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size() >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
            Future<?>[] futures = new Future[nthreads];
     ...
     * 
     * @see com.cern.colt.matrix.tobject.algo.ObjectFormatter
     */

    public String toString() {
        return new com.cern.colt.matrix.tobject.algo.ObjectFormatter().toString(this);
    }
     ...
     * {@link com.cern.colt.matrix.tobject.algo.ObjectSorting#sort(ObjectMatrix2D,int)}
     * . For more advanced sorting functionality, see
     * {@link com.cern.colt.matrix.tobject.algo.ObjectSorting}.
     * 
    ...
    public ObjectMatrix2D viewSorted(int column) {
        return com.cern.colt.matrix.tobject.algo.ObjectSorting.mergeSort.sort(this, column);
    }
