...
import com.cern.colt.matrix.tfloat.algo.decomposition.DenseFloatCholeskyDecomposition;
import com.cern.colt.matrix.tfloat.algo.decomposition.DenseFloatEigenvalueDecomposition;
import com.cern.colt.matrix.tfloat.algo.decomposition.DenseFloatLUDecomposition;
import com.cern.colt.matrix.tfloat.algo.decomposition.DenseFloatQRDecomposition;
import com.cern.colt.matrix.tfloat.algo.decomposition.DenseFloatSingularValueDecomposition;
...
import com.cern.colt.matrix.tfloat.impl.SparseCCFloatMatrix2D;
 ...
 */
public class DenseFloatAlgebra extends com.cern.colt.PersistentObject {
     ...
     * Returns sqrt(a^2 + b^2) without under/overflow.
     */
    public static com.cern.colt.function.tfloat.FloatFloatFunction hypotFunction() {
        return new com.cern.colt.function.tfloat.FloatFloatFunction() {
    ...
    public float normF(FloatMatrix2D A) {
        if (A.size() == 0)
            return 0;
        return A.aggregate(hypotFunction(), FloatFunctions.identity);
    }
    ...
    public FloatMatrix2D permuteRows(final FloatMatrix2D A, int[] indexes, int[] work) {
        ...
        com.cern.colt.GenericPermuting.permute(indexes, swapper, work, null);
        return A;
    }
    ...
    public FloatMatrix2D pow(FloatMatrix2D A, int p) {
        ...
        int k = com.cern.colt.matrix.tbit.QuickBitVector.mostSignificantBit(p);
    ...
    public String toString(FloatMatrix2D matrix) {
        final com.cern.colt.list.tobject.ObjectArrayList names = new com.cern.colt.list.tobject.ObjectArrayList();
        final com.cern.colt.list.tobject.ObjectArrayList values = new com.cern.colt.list.tobject.ObjectArrayList();
        ...
        com.cern.colt.function.tint.IntComparator comp = new com.cern.colt.function.tint.IntComparator() {
        ...
        com.cern.colt.GenericSorting.quickSort(0, names.size(), comp, swapper);
