...
import com.edu.emory.mathcs.csparsej.tdouble.Dcs_dfs;
...
public class Dcs_reach {
    ...
    public static int cs_reach(Dcs G, Dcs B, int k, int[] xi, int[] pinv) {
        ...
        if (!com.edu.emory.mathcs.csparsej.tdouble.Dcs_util.CS_CSC(G) || !com.edu.emory.mathcs.csparsej.tdouble.Dcs_util.CS_CSC(B) || xi == null)
        ...
        for (p = Bp[k]; p < Bp[k + 1]; p++) {
            if (!com.edu.emory.mathcs.csparsej.tdouble.Dcs_util.CS_MARKED(Gp, Bi[p])) /* start a dfs at unmarked node i */
            {
