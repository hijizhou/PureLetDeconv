...
package com.edu.emory.mathcs.csparsej.tfloat;

import com.edu.emory.mathcs.csparsej.tfloat.*;
...
import com.edu.emory.mathcs.csparsej.tfloat.Scs_qr;
import com.edu.emory.mathcs.csparsej.tfloat.Scs_sqr;
...
public class Scs_qrsol {
    ...
    public static boolean cs_qrsol(int order, Scs A, float[] b) {
        ...
        m = A.m;
        if (m >= n) {
            S = com.edu.emory.mathcs.csparsej.tfloat.Scs_sqr.cs_sqr(order, A, true); /* ordering and symbolic analysis */
            N = com.edu.emory.mathcs.csparsej.tfloat.Scs_qr.cs_qr(A, S); /* numeric QR factorization */
            x = new float[S != null ? S.m2 : 1]; /* get workspace */
            ok = (S != null && N != null);
            if (ok) {
                com.edu.emory.mathcs.csparsej.tfloat.Scs_ipvec.cs_ipvec(S.pinv, b, x, m); /* x(0:m-1) = b(p(0:m-1) */
            ...
            if (ok) {
                com.edu.emory.mathcs.csparsej.tfloat.Scs_pvec.cs_pvec(S.q, b, x, m); /* x(q(0:m-1)) = b(0:m-1) */
