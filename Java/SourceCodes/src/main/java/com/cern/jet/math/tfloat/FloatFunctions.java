 ...
 */
package com.cern.jet.math.tfloat;

import com.cern.colt.function.tfloat.FloatFloatFunction;
import com.cern.colt.function.tfloat.FloatFloatProcedure;
 ...
 * {@link Math} as function objects, as well as a few more basic
 * functions.
 * <p>
 ...
 * for call-backs.
 * <p>
 * Unary functions are of type {@link FloatFunction} ,
 * binary functions of type {@link FloatFloatFunction}
 * . All can be retrieved via <tt>public 
 static final</tt> variables named after the function. Unary predicates are of
 * type {@link FloatProcedure}, binary predicates of
 * type {@link FloatFloatProcedure}. All can be
...
public class FloatFunctions extends Object {
    ...
    public static void demo2(int size) {
        ...
        // emptyLoop
        com.cern.colt.Timer emptyLoop = new com.cern.colt.Timer().start();
        a = 0;
        b = 0;
        float sum = 0;
        for (int i = size; --i >= 0;) {
     ...
     * {@link com.cern.jet.random.tfloat.engine.FloatMersenneTwister} and is seeded
     * with the current time.
     * <p>
     * Note that any random engine derived from
     * {@link com.cern.jet.random.tfloat.engine.FloatRandomEngine} and any random
     * distribution derived from
     * {@link com.cern.jet.random.tfloat.AbstractFloatDistribution} are function
