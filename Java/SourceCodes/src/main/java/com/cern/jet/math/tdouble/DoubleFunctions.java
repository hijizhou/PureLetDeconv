 ...
 */
package com.cern.jet.math.tdouble;

import com.cern.colt.function.tdouble.DoubleDoubleFunction;
import com.cern.colt.function.tdouble.DoubleDoubleProcedure;
 ...
 * for call-backs.
 * <p>
 * Unary functions are of type {@link DoubleFunction}
 * , binary functions of type
 * {@link DoubleDoubleFunction}. All can be retrieved
 * via <tt>public 
 static final</tt> variables named after the function. Unary predicates are of
 * type {@link DoubleProcedure}, binary predicates of
 * type {@link DoubleDoubleProcedure}. All can be
...
public class DoubleFunctions extends Object {
     ...
     * {@link com.cern.jet.random.tdouble.engine.DoubleMersenneTwister} and is
     * seeded with the current time.
     * <p>
     * Note that any random engine derived from
     * {@link com.cern.jet.random.tdouble.engine.DoubleRandomEngine} and any random
     * distribution derived from
     * {@link com.cern.jet.random.tdouble.AbstractDoubleDistribution} are function
