...
// FloatQuantileFinder {
class ExactFloatQuantileFinder extends com.cern.colt.PersistentObject implements FloatQuantileFinder {
    /**
     * 
     */
    ...
    public float phi(float element) {
        this.sort();
        return com.cern.jet.stat.tfloat.FloatDescriptive.rankInterpolated(buffer, element) / this.size();
    }
    ...
    public FloatArrayList quantileElements(FloatArrayList phis) {
        this.sort();
        return com.cern.jet.stat.tfloat.FloatDescriptive.quantiles(this.buffer, phis);
        /*
