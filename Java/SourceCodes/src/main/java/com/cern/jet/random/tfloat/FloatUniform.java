...
public class FloatUniform extends AbstractContinousFloatDistribution {
     ...
     * using a {@link com.cern.jet.random.tfloat.engine.FloatMersenneTwister} seeded
     * with the given seed.
     */
    public FloatUniform(float min, float max, int seed) {
        this(min, max, new com.cern.jet.random.tfloat.engine.FloatMersenneTwister(seed));
    }
