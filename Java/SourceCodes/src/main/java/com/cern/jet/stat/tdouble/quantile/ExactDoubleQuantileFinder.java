 ...
 */
package com.cern.jet.stat.tdouble.quantile;
...
public class ExactDoubleQuantileFinder extends com.cern.colt.PersistentObject implements DoubleQuantileFinder {
    /**
     * 
     */
     ...
     */
    public boolean forEach(com.cern.colt.function.tdouble.DoubleProcedure procedure) {
    ...
    public double phi(double element) {
        this.sort();
        return com.cern.jet.stat.tdouble.DoubleDescriptive.rankInterpolated(buffer, element) / this.size();
    }
    ...
    public DoubleArrayList quantileElements(DoubleArrayList phis) {
        this.sort();
        return com.cern.jet.stat.tdouble.DoubleDescriptive.quantiles(this.buffer, phis);
        /*
