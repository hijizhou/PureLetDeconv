...
public class DenseFComplexMatrix1D extends FComplexMatrix1D {
    ...
    public FComplexMatrix1D assign(final com.cern.colt.function.tfcomplex.FComplexFComplexFunction function) {
    ...
    public FComplexMatrix1D assign(final com.cern.colt.function.tfcomplex.FComplexRealFunction function) {
        if (this.elements == null)
            throw new InternalError();
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
