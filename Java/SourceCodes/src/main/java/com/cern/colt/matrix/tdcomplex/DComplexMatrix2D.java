...
public abstract class DComplexMatrix2D extends AbstractMatrix2D {
     ...
     * @see com.cern.jet.math.tdcomplex.DComplexFunctions
     */
     ...
     * @see com.cern.jet.math.tdcomplex.DComplexFunctions
     */
    public DComplexMatrix2D assign(final com.cern.colt.function.tdcomplex.DComplexDComplexFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size() >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see com.cern.jet.math.tdcomplex.DComplexFunctions
     */
    public DComplexMatrix2D assign(final com.cern.colt.function.tdcomplex.DComplexRealFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size() >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
            Future<?>[] futures = new Future[nthreads];
     ...
     */
    public DComplexMatrix2D assign(final DComplexMatrix2D y,
            final com.cern.colt.function.tdcomplex.DComplexDComplexDComplexFunction function, IntArrayList rowList,
    ...
    public boolean equals(double[] value) {
        return com.cern.colt.matrix.tdcomplex.algo.DComplexProperty.DEFAULT.equals(this, value);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return com.cern.colt.matrix.tdcomplex.algo.DComplexProperty.DEFAULT.equals(this, (DComplexMatrix2D) obj);
    }
...
//                    + B.toStringShort() + ", " + CC.toStringShort());
    ...
    public double[] zSum() {
        ...
        return aggregate(com.cern.jet.math.tdcomplex.DComplexFunctions.plus,
                com.cern.jet.math.tdcomplex.DComplexFunctions.identity);
    }
