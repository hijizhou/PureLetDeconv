 ...
 */
public class IntProperty extends com.cern.colt.PersistentObject {
    /**
     * 
     */
    ...
    public boolean isOrthogonal(IntMatrix2D A) {
        checkSquare(A);
        return equals(A.zMult(A, null, 1, 0, false, true), com.cern.colt.matrix.tint.IntFactory2D.dense.identity(A.rows()));
    }
