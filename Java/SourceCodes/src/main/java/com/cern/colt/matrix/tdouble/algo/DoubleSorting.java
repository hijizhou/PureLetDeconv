 ...
 * 
 */
public class DoubleSorting extends com.cern.colt.PersistentObject {
    /**
     * 
     */
     ...
     */
    public DoubleMatrix1D sort(final DoubleMatrix1D vector, final com.cern.colt.function.tdouble.DoubleComparator c) {
     ...
     * @return sorted indexes
     */
    public int[] sortIndex(final DoubleMatrix1D vector, final com.cern.colt.function.tdouble.DoubleComparator c) {
        int[] indexes = new int[(int) vector.size()]; // row indexes to reorder
        // instead of matrix itself
        for (int i = indexes.length; --i >= 0;)
            indexes[i] = i;
     ...
     * DoubleMatrix2D sorted = quickSort(matrix, com.hep.aida.bin.BinFunctions1D.median);
     * //DoubleMatrix2D sorted = quickSort(matrix,com.hep.aida.bin.BinFunctions1D.sumOfLogarithms);
     * 
     * // THE SLOW VERSION (takes some 300 secs)
     * DoubleMatrix1DComparator comparator = new DoubleMatrix1DComparator() {
     *     public int compare(DoubleMatrix1D x, DoubleMatrix1D y) {
     *         double a = com.cern.colt.matrix.doublealgo.Statistic.bin(x).median();
     *         double b = com.cern.colt.matrix.doublealgo.Statistic.bin(y).median();
     *         // double a = x.aggregate(F.plus,F.log);
     *         // double b = y.aggregate(F.plus,F.log);
     *         return a &lt; b ? -1 : a == b ? 0 : 1;
     *     }
     ...
     *         matrix is left unaffected.</b>
     */
    public DoubleMatrix2D sort(DoubleMatrix2D matrix, com.hep.aida.tdouble.bin.DoubleBinFunction1D aggregate) {
        ...
        com.hep.aida.tdouble.bin.DoubleBinFunction1D[] func = { aggregate };
    ...
    public static void zdemo3() {
        ...
        com.cern.colt.function.tdouble.DoubleComparator comp = new com.cern.colt.function.tdouble.DoubleComparator() {
            public int compare(double a, double b) {
                double as = Math.sin(a);
                double bs = Math.sin(b);
                return as < bs ? -1 : as == bs ? 0 : 1;
        ...
        sorted.assign(com.cern.jet.math.tdouble.DoubleFunctions.sin);
        /*
         * sorted.assign( new com.cern.colt.function.DoubleFunction() { public
    ...
    protected static void zdemo4() {
        ...
        matrix1.assign(matrix2, com.cern.jet.math.tdouble.DoubleFunctions.pow);

        /*
         * matrix1.assign(matrix2, new com.cern.colt.function.DoubleDoubleFunction() {
    ...
    public static void zdemo5(int rows, int columns, boolean print) {
        ...
        final com.cern.jet.math.tdouble.DoubleFunctions F = com.cern.jet.math.tdouble.DoubleFunctions.functions;
        DoubleMatrix2D A = DoubleFactory2D.dense.make(rows, columns);
        A.assign(new com.cern.jet.random.tdouble.engine.DRand()); // initialize randomly
        timer.stop().display();
        ...
        timer.reset().start();
        // THE QUICK VERSION (takes some 10 secs)
        A = sort.sort(A, com.hep.aida.tdouble.bin.DoubleBinFunctions1D.median);
        ...
        if (print) {
            ...
            com.hep.aida.tdouble.bin.DoubleBinFunction1D[] funs = { com.hep.aida.tdouble.bin.DoubleBinFunctions1D.median,
                    com.hep.aida.tdouble.bin.DoubleBinFunctions1D.sumLog,
                    com.hep.aida.tdouble.bin.DoubleBinFunctions1D.geometricMean };
            ...
            System.out.println("first part of sorted result = \n"
                    + new DoubleFormatter("%G").toTitleString(A
        ...
        DoubleMatrix1DComparator fun = new DoubleMatrix1DComparator() {
            public int compare(DoubleMatrix1D x, DoubleMatrix1D y) {
                ...
                double b = DoubleStatistic.bin(y).median();
                // double a = x.aggregate(F.plus,F.log);
                // double b = y.aggregate(F.plus,F.log);
                return a < b ? -1 : (a == b) ? 0 : 1;
            }
    ...
    public static void zdemo8(int size) {
        ...
        final com.cern.jet.math.tdouble.DoubleFunctions F = com.cern.jet.math.tdouble.DoubleFunctions.functions;
        DoubleMatrix1D A = com.cern.colt.matrix.tdouble.DoubleFactory1D.dense.random(size);
        System.out.print("now quick sorting... ");
        com.cern.colt.Timer timer = new com.cern.colt.Timer().start();
        quickSort.sort(A);
        timer.stop().display();
