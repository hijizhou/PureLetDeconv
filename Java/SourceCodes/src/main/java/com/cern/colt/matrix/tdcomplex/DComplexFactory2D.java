 ...
 */
public class DComplexFactory2D extends com.cern.colt.PersistentObject {
    ...
    public DComplexMatrix2D random(int rows, int columns) {
        return make(rows, columns).assign(com.cern.jet.math.tdcomplex.DComplexFunctions.random());
    }
