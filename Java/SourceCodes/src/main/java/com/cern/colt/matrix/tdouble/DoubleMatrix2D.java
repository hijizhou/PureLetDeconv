 ...
 */
package com.cern.colt.matrix.tdouble;
...
public abstract class DoubleMatrix2D extends AbstractMatrix2D {
     ...
     * @see DoubleFunctions
     */
    public double aggregate(final com.cern.colt.function.tdouble.DoubleDoubleFunction aggr,
            final com.cern.colt.function.tdouble.DoubleFunction f) {
        if (size() == 0)
            return Double.NaN;
        double a = 0;
     ...
     */
    public double aggregate(final com.cern.colt.function.tdouble.DoubleDoubleFunction aggr,
            final com.cern.colt.function.tdouble.DoubleFunction f, final com.cern.colt.function.tdouble.DoubleProcedure cond) {
        if (size() == 0)
            return Double.NaN;
        double a = 0;
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
     ...
     */
    public double aggregate(final com.cern.colt.function.tdouble.DoubleDoubleFunction aggr,
            final com.cern.colt.function.tdouble.DoubleFunction f, final IntArrayList rowList, final IntArrayList columnList) {
        if (size() == 0)
            return Double.NaN;
     ...
     * @see DoubleFunctions
     */
    public double aggregate(final DoubleMatrix2D other, final com.cern.colt.function.tdouble.DoubleDoubleFunction aggr,
            final com.cern.colt.function.tdouble.DoubleDoubleFunction f) {
        checkShape(other);
        if (size() == 0)
            return Double.NaN;
        double a = 0;
     ...
     * 	 matrix.assign(com.cern.jet.math.Functions.sin);
     * 	 --&gt;
     * 	 2 x 2 matrix
     * 	 0.479426  0.997495 
     * 	 0.598472 -0.350783
     ...
     * @see DoubleFunctions
     */
    public DoubleMatrix2D assign(final com.cern.colt.function.tdouble.DoubleFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (rows * columns >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see DoubleFunctions
     */
    public DoubleMatrix2D assign(final com.cern.colt.function.tdouble.DoubleProcedure cond,
            final com.cern.colt.function.tdouble.DoubleFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (rows * columns >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
     ...
     * 
     */
    public DoubleMatrix2D assign(final com.cern.colt.function.tdouble.DoubleProcedure cond, final double value) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (rows * columns >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
            Future<?>[] futures = new Future[nthreads];
     ...
     * 	 4 6
     * 
     * 	 m1.assign(m2, com.cern.jet.math.Functions.pow);
     * 	 --&gt;
     * 	 m1 == 2 x 2 matrix
     * 	 1   1 
     * 	 16 729
     ...
     * @see DoubleFunctions
     */
    public DoubleMatrix2D assign(final DoubleMatrix2D y, final com.cern.colt.function.tdouble.DoubleDoubleFunction function) {
        checkShape(y);
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (rows * columns >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
    ...
    public DoubleMatrix2D assign(final DoubleMatrix2D y,
            final com.cern.colt.function.tdouble.DoubleDoubleFunction function, IntArrayList rowList,
    ...
    public boolean equals(double value) {
        return com.cern.colt.matrix.tdouble.algo.DoubleProperty.DEFAULT.equals(this, value);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return com.cern.colt.matrix.tdouble.algo.DoubleProperty.DEFAULT.equals(this, (DoubleMatrix2D) obj);
    }
     ...
     * 
     * @see com.cern.colt.matrix.tdouble.algo.DoubleFormatter
     */

    public String toString() {
        return new com.cern.colt.matrix.tdouble.algo.DoubleFormatter().toString(this);
    }
     ...
     * {@link com.cern.colt.matrix.tdouble.algo.DoubleSorting#sort(DoubleMatrix2D,int)}
     * . For more advanced sorting functionality, see
     * {@link com.cern.colt.matrix.tdouble.algo.DoubleSorting}.
     * 
    ...
    public DoubleMatrix2D viewSorted(int column) {
        return com.cern.colt.matrix.tdouble.algo.DoubleSorting.mergeSort.sort(this, column);
    }
     ...
     * com.cern.colt.function.Double9Function f = new
     * com.cern.colt.function.Double9Function() {    public final
     ...
     * neighbors com.cern.colt.function.Double9Function g = new
     * com.cern.colt.function.Double9Function() {    public final
     * double apply(       double a00, double a01,
     * double a02,       double a10, double a11,
     * double a12,       double a20, double a21,
     ...
     */
    public void zAssign8Neighbors(DoubleMatrix2D B, com.cern.colt.function.tdouble.Double9Function function) {
        if (function == null)
    ...
    public double zSum() {
        if (size() == 0)
            return 0;
        return aggregate(DoubleFunctions.plus, DoubleFunctions.identity);
    }
