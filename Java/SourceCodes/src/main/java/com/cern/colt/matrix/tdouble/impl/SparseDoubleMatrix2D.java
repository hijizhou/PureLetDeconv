...
import com.cern.colt.map.tdouble.AbstractLongDoubleMap;
import com.cern.colt.map.tdouble.OpenLongDoubleHashMap;
 ...
 * {@link OpenLongDoubleHashMap}, which is a compact and
...
public class SparseDoubleMatrix2D extends DoubleMatrix2D {
     ...
     * to memory usage see {@link OpenLongDoubleHashMap}.
     * 
     * @param rows
     *            the number of rows the matrix shall have.
     * @param columns
    ...
    public DoubleMatrix2D assign(com.cern.colt.function.tdouble.DoubleFunction function) {
        if (this.isNoView && function instanceof com.cern.jet.math.tdouble.DoubleMult) { // x[i] = mult*x[i]
    ...
    public DoubleMatrix2D assign(final DoubleMatrix2D y, com.cern.colt.function.tdouble.DoubleDoubleFunction function) {
        ...
        } else if (function == com.cern.jet.math.tdouble.DoubleFunctions.mult) { // x[i] = x[i] * y[i]
            this.elements.forEachPair(new com.cern.colt.function.tdouble.LongDoubleProcedure() {
        ...
        } else if (function == com.cern.jet.math.tdouble.DoubleFunctions.div) { // x[i] = x[i] /  y[i]
            this.elements.forEachPair(new com.cern.colt.function.tdouble.LongDoubleProcedure() {
                public boolean apply(long key, double value) {
                    int i = (int) (key / columns);
                    int j = (int) (key % columns);
    ...
    public SparseDoubleMatrix2D assign(final int[] rowIndexes, final int[] columnIndexes, final double value,
            final com.cern.colt.function.tdouble.DoubleDoubleFunction function) {
        int size = rowIndexes.length;
        if (function == com.cern.jet.math.tdouble.DoubleFunctions.plus) { // x[i] = x[i] + y[i]
    ...
    public DoubleMatrix1D zMult(DoubleMatrix1D y, DoubleMatrix1D z, final double alpha, double beta,
        ...
        if (!ignore)
            z.assign(com.cern.jet.math.tdouble.DoubleFunctions.mult(beta));
    ...
    public DoubleMatrix2D zMult(DoubleMatrix2D B, DoubleMatrix2D C, final double alpha, double beta,
        ...
        final com.cern.jet.math.tdouble.DoublePlusMultSecond fun = com.cern.jet.math.tdouble.DoublePlusMultSecond.plusMult(0);
