 ...
 */
package com.cern.colt.matrix.tfcomplex;
...
public abstract class FComplexMatrix2D extends AbstractMatrix2D {
     ...
     * @see com.cern.jet.math.tfcomplex.FComplexFunctions
     */
     ...
     * @see com.cern.jet.math.tfcomplex.FComplexFunctions
     */
    public FComplexMatrix2D assign(final com.cern.colt.function.tfcomplex.FComplexFComplexFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size() >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see com.cern.jet.math.tfcomplex.FComplexFunctions
     */
    public FComplexMatrix2D assign(final com.cern.colt.function.tfcomplex.FComplexRealFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size() >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
            Future<?>[] futures = new Future[nthreads];
     ...
     */
    public FComplexMatrix2D assign(final FComplexMatrix2D y,
            final com.cern.colt.function.tfcomplex.FComplexFComplexFComplexFunction function, IntArrayList rowList,
    ...
    public boolean equals(float[] value) {
        return com.cern.colt.matrix.tfcomplex.algo.FComplexProperty.DEFAULT.equals(this, value);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return com.cern.colt.matrix.tfcomplex.algo.FComplexProperty.DEFAULT.equals(this, (FComplexMatrix2D) obj);
    }
    ...
    public float[] zSum() {
        ...
        return aggregate(com.cern.jet.math.tfcomplex.FComplexFunctions.plus,
                com.cern.jet.math.tfcomplex.FComplexFunctions.identity);
    }
