...
import com.cern.colt.function.tint.IntFunction;
import com.cern.colt.function.tint.IntIntFunction;
import com.cern.colt.function.tint.IntProcedure;
...
public class DenseColumnIntMatrix2D extends IntMatrix2D {
    ...
    public IntMatrix2D assign(final IntMatrix2D y, final IntIntFunction function) {
        ...
        if (function instanceof com.cern.jet.math.tint.IntPlusMultFirst) {
