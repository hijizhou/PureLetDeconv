...
public class SmpDoubleBlas implements DoubleBlas {
    ...
    public void assign(DoubleMatrix2D A, final com.cern.colt.function.tdouble.DoubleFunction function) {
        A.assign(function);
    }
    ...
    public void dger(double alpha, DoubleMatrix1D x, DoubleMatrix1D y, DoubleMatrix2D A) {
        com.cern.jet.math.tdouble.DoublePlusMultSecond fun = com.cern.jet.math.tdouble.DoublePlusMultSecond.plusMult(0);
        int rows = A.rows();
