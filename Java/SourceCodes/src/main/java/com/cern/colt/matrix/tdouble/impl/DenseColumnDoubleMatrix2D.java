...
import com.cern.colt.function.tdouble.DoubleFunction;
import com.cern.colt.function.tdouble.DoubleProcedure;
...
public class DenseColumnDoubleMatrix2D extends DoubleMatrix2D {
    ...
    public DoubleMatrix2D assign(final DoubleMatrix2D y, final DoubleDoubleFunction function) {
        ...
        if (function instanceof com.cern.jet.math.tdouble.DoublePlusMultFirst) {
