...
import com.cern.colt.matrix.tfcomplex.impl.SparseFComplexMatrix2D;
 ...
 */
public class FComplexFactory2D extends com.cern.colt.PersistentObject {
    ...
    public FComplexMatrix2D random(int rows, int columns) {
        return make(rows, columns).assign(com.cern.jet.math.tfcomplex.FComplexFunctions.random());
    }
