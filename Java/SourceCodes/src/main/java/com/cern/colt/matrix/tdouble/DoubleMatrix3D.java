...
public abstract class DoubleMatrix3D extends AbstractMatrix3D {
     ...
     */
    public double aggregate(final com.cern.colt.function.tdouble.DoubleDoubleFunction aggr,
            final com.cern.colt.function.tdouble.DoubleFunction f, final IntArrayList sliceList,
     ...
     * @see DoubleFunctions
     */
    public double aggregate(final DoubleMatrix3D other, final com.cern.colt.function.tdouble.DoubleDoubleFunction aggr,
     ...
     * @see DoubleFunctions
     */
    public DoubleMatrix3D assign(final com.cern.colt.function.tdouble.DoubleFunction function) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (slices * rows * columns >= ConcurrencyUtils.getThreadsBeginN_3D())) {
            nthreads = Math.min(nthreads, slices);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see DoubleFunctions
     */
    public DoubleMatrix3D assign(final com.cern.colt.function.tdouble.DoubleProcedure cond,
            final com.cern.colt.function.tdouble.DoubleFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (slices * rows * columns >= ConcurrencyUtils.getThreadsBeginN_3D())) {
            nthreads = Math.min(nthreads, slices);
     ...
     * 
     */
    public DoubleMatrix3D assign(final com.cern.colt.function.tdouble.DoubleProcedure cond, final double value) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (slices * rows * columns >= ConcurrencyUtils.getThreadsBeginN_3D())) {
            nthreads = Math.min(nthreads, slices);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see DoubleFunctions
     */
    public DoubleMatrix3D assign(final DoubleMatrix3D y, final com.cern.colt.function.tdouble.DoubleDoubleFunction function) {
        checkShape(y);
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (slices * rows * columns >= ConcurrencyUtils.getThreadsBeginN_3D())) {
            nthreads = Math.min(nthreads, slices);
    ...
    public DoubleMatrix3D assign(final DoubleMatrix3D y,
            final com.cern.colt.function.tdouble.DoubleDoubleFunction function, final IntArrayList sliceList,
            final IntArrayList rowList, final IntArrayList columnList) {
        checkShape(y);
    ...
    public boolean equals(Object obj) {
        ...
        return com.cern.colt.matrix.tdouble.algo.DoubleProperty.DEFAULT.equals(this, (DoubleMatrix3D) obj);
    }
     ...
     * information, see
     * {@link com.cern.colt.matrix.tdouble.algo.DoubleSorting#sort(DoubleMatrix3D,int,int)}
    ...
    public DoubleMatrix3D viewSorted(int row, int column) {
        return com.cern.colt.matrix.tdouble.algo.DoubleSorting.mergeSort.sort(this, row, column);
    }
     ...
     * 
     * com.cern.colt.function.Double27Function f = new
     * com.cern.colt.function.Double27Function() {    public final
     ...
     *             .
     */
    public void zAssign27Neighbors(DoubleMatrix3D B, com.cern.colt.function.tdouble.Double27Function function) {
        if (function == null)
