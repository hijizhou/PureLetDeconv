...
public interface DoubleBlas {
     ...
     */
    public void assign(DoubleMatrix2D A, com.cern.colt.function.tdouble.DoubleFunction function);
     ...
     * @see com.cern.jet.math.tdouble.DoubleFunctions
     */
    public void assign(DoubleMatrix2D x, DoubleMatrix2D y, com.cern.colt.function.tdouble.DoubleDoubleFunction function);

    /**
     * Returns the sum of absolute values; <tt>|x[0]| + |x[1]| + ... </tt>. In
     * fact equivalent to
     * <tt>x.aggregate(com.cern.jet.math.Functions.plus, com.cern.jet.math.Functions.abs)</tt>
     * .
     * 
     * @param x
     *            the first vector.
     ...
     * <tt>y.assign(x,com.cern.jet.math.Functions.plusMult(alpha))</tt>.
     * 
     * @param alpha
     *            a scale factor.
     * @param x
     ...
     * <tt>B.assign(A,com.cern.jet.math.Functions.plusMult(alpha))</tt>.
     * 
     * @param alpha
     *            a scale factor.
     * @param A
     ...
     * <tt>x.assign(com.cern.jet.math.Functions.mult(alpha))</tt>.
     * 
     * @param alpha
     *            a scale factor.
     * @param x
     ...
     * <tt>A.assign(com.cern.jet.math.Functions.mult(alpha))</tt>.
     * 
     * @param alpha
     *            a scale factor.
     * @param A
