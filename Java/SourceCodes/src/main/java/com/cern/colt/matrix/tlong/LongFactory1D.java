...
import com.cern.colt.matrix.tlong.impl.SparseLongMatrix1D;
 ...
 */
public class LongFactory1D extends com.cern.colt.PersistentObject {
    /**
     * 
     */
     ...
     * @return a new matrix.
     */
    public LongMatrix1D make(com.cern.colt.list.tlong.AbstractLongList values) {
    ...
    public LongMatrix1D random(int size) {
        return make(size).assign(LongFunctions.random());
    }
     ...
     * @return a new list.
     */
    public com.cern.colt.list.tlong.LongArrayList toList(LongMatrix1D values) {
        int size = (int) values.size();
        com.cern.colt.list.tlong.LongArrayList list = new com.cern.colt.list.tlong.LongArrayList(size);
        list.setSize(size);
        for (int i = size; --i >= 0;)
