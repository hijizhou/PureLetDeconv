...
public abstract class FloatMatrix1D extends AbstractMatrix1D {
     ...
     */
    public float aggregate(final com.cern.colt.function.tfloat.FloatFloatFunction aggr,
            final com.cern.colt.function.tfloat.FloatFunction f, final IntArrayList indexList) {
        if (size() == 0)
            return Float.NaN;
     ...
     * @see FloatFunctions
     */
    public float aggregate(final FloatMatrix1D other, final com.cern.colt.function.tfloat.FloatFloatFunction aggr,
     ...
     * @see FloatFunctions
     */
    public FloatMatrix1D assign(final com.cern.colt.function.tfloat.FloatFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see FloatFunctions
     */
    public FloatMatrix1D assign(final com.cern.colt.function.tfloat.FloatProcedure cond,
            final com.cern.colt.function.tfloat.FloatFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
     ...
     * 
     */
    public FloatMatrix1D assign(final com.cern.colt.function.tfloat.FloatProcedure cond, final float value) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see FloatFunctions
     */
    public FloatMatrix1D assign(final FloatMatrix1D y, final com.cern.colt.function.tfloat.FloatFloatFunction function) {
        checkSize(y);
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
     ...
     * @see FloatFunctions
     */
    public FloatMatrix1D assign(FloatMatrix1D y, com.cern.colt.function.tfloat.FloatFloatFunction function,
    ...
    public boolean equals(Object obj) {
        ...
        return com.cern.colt.matrix.tfloat.algo.FloatProperty.DEFAULT.equals(this, (FloatMatrix1D) obj);
    }
     ...
     * @return the new view.
     */
    public FloatMatrix1D viewSelection(com.cern.colt.function.tfloat.FloatProcedure condition) {
     ...
     * information, see
     * {@link com.cern.colt.matrix.tfloat.algo.FloatSorting#sort(FloatMatrix1D)}.
    ...
    public FloatMatrix1D viewSorted() {
        return com.cern.colt.matrix.tfloat.algo.FloatSorting.mergeSort.sort(this);
    }
