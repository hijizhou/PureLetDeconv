...
import com.cern.colt.matrix.tfloat.impl.SparseFloatMatrix1D;
 ...
 */
public class FloatProperty extends com.cern.colt.PersistentObject {
    ...
    /**
     */
    protected static String get(com.cern.colt.list.tobject.ObjectArrayList list, int index) {
    ...
    public boolean isOrthogonal(FloatMatrix2D A) {
        checkSquare(A);
        return equals(A.zMult(A, null, 1, 0, false, true), com.cern.colt.matrix.tfloat.FloatFactory2D.dense.identity(A
                .rows()));
    }
