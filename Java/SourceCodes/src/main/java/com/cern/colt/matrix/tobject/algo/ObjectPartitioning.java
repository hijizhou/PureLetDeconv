package com.cern.colt.matrix.tobject.algo;
 ...
 * 
 * @see com.cern.colt.Partitioning "Partitioning arrays (provides more
 *      documentation)"
 * 
...
public class ObjectPartitioning extends Object {
    ...
    /**
     * Same as
     * {@link com.cern.colt.Partitioning#partition(int[],int,int,int[],int,int,int[])}
    ...
    public static void partition(ObjectMatrix2D matrix, int[] rowIndexes, int rowFrom, int rowTo, int column,
        ...
        com.cern.colt.Partitioning.genericPartition(rowFrom, rowTo, splitFrom, splitTo, splitIndexes, comp, comp2, comp3,
                swapper);
    }
    ...
    private static void xPartitionOld(ObjectMatrix2D matrix, ObjectMatrix1D column, int from, int to,
         ...
         * com.cern.colt.Sorting.binarySearchFromTo(splitters,column.getQuick(m),splitFrom,splitTo);
