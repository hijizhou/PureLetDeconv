 ...
 */
package com.cern.colt.matrix.tlong.algo;
 ...
 */
public class LongProperty extends com.cern.colt.PersistentObject {
    /**
     * 
     */
    ...
    public boolean isOrthogonal(LongMatrix2D A) {
        checkSquare(A);
        return equals(A.zMult(A, null, 1, 0, false, true), com.cern.colt.matrix.tlong.LongFactory2D.dense
                .identity(A.rows()));
    }
