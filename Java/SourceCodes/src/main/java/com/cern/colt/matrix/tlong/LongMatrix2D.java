...
import com.cern.colt.matrix.tlong.impl.DenseLongMatrix1D;
import com.cern.colt.matrix.tlong.impl.DenseLongMatrix2D;
...
public abstract class LongMatrix2D extends AbstractMatrix2D {
     ...
     */
    public long aggregate(final com.cern.colt.function.tlong.LongLongFunction aggr,
            final com.cern.colt.function.tlong.LongFunction f, final com.cern.colt.function.tlong.LongProcedure cond) {
        if (size() == 0)
            throw new IllegalArgumentException("size == 0");
        long a = 0;
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
     ...
     */
    public long aggregate(final com.cern.colt.function.tlong.LongLongFunction aggr,
            final com.cern.colt.function.tlong.LongFunction f, final IntArrayList rowList, final IntArrayList columnList) {
        if (size() == 0)
            throw new IllegalArgumentException("size == 0");
     ...
     * @see com.cern.jet.math.tlong.LongFunctions
     */
    public long aggregate(final LongMatrix2D other, final com.cern.colt.function.tlong.LongLongFunction aggr,
     ...
     * @see com.cern.jet.math.tlong.LongFunctions
     */
    public LongMatrix2D assign(final com.cern.colt.function.tlong.LongFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (rows * columns >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see com.cern.jet.math.tlong.LongFunctions
     */
    public LongMatrix2D assign(final com.cern.colt.function.tlong.LongProcedure cond,
            final com.cern.colt.function.tlong.LongFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (rows * columns >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
     ...
     * 
     */
    public LongMatrix2D assign(final com.cern.colt.function.tlong.LongProcedure cond, final long value) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (rows * columns >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see com.cern.jet.math.tlong.LongFunctions
     */
    public LongMatrix2D assign(final LongMatrix2D y, final com.cern.colt.function.tlong.LongLongFunction function) {
        checkShape(y);
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (rows * columns >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
    ...
    public boolean equals(Object obj) {
        ...
        return com.cern.colt.matrix.tlong.algo.LongProperty.DEFAULT.equals(this, (LongMatrix2D) obj);
    }
     ...
     * {@link com.cern.colt.matrix.tlong.algo.LongSorting#sort(LongMatrix2D,int)}.
    ...
    public LongMatrix2D viewSorted(int column) {
        return com.cern.colt.matrix.tlong.algo.LongSorting.mergeSort.sort(this, column);
    }
