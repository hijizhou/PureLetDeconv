...
import com.cern.colt.matrix.tdouble.impl.SparseDoubleMatrix2D;
 ...
 */
public class DoubleFactory2D extends com.cern.colt.PersistentObject {
    ...
    public DoubleMatrix2D random(int rows, int columns) {
        return make(rows, columns).assign(DoubleFunctions.random());
    }
