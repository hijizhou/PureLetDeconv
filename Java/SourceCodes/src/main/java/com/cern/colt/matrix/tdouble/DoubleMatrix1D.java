...
public abstract class DoubleMatrix1D extends AbstractMatrix1D {
     ...
     */
    public double aggregate(final com.cern.colt.function.tdouble.DoubleDoubleFunction aggr,
            final com.cern.colt.function.tdouble.DoubleFunction f, final IntArrayList indexList) {
        if (size() == 0)
            return Double.NaN;
     ...
     * @see DoubleFunctions
     */
    public double aggregate(final DoubleMatrix1D other, final com.cern.colt.function.tdouble.DoubleDoubleFunction aggr,
     ...
     * @see DoubleFunctions
     */
    public DoubleMatrix1D assign(final com.cern.colt.function.tdouble.DoubleFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see DoubleFunctions
     */
    public DoubleMatrix1D assign(final com.cern.colt.function.tdouble.DoubleProcedure cond,
            final com.cern.colt.function.tdouble.DoubleFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
     ...
     * 
     */
    public DoubleMatrix1D assign(final com.cern.colt.function.tdouble.DoubleProcedure cond, final double value) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see DoubleFunctions
     */
    public DoubleMatrix1D assign(final DoubleMatrix1D y, final com.cern.colt.function.tdouble.DoubleDoubleFunction function) {
        checkSize(y);
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
     ...
     * @see DoubleFunctions
     */
    public DoubleMatrix1D assign(DoubleMatrix1D y, com.cern.colt.function.tdouble.DoubleDoubleFunction function,
            IntArrayList nonZeroIndexes) {
        checkSize(y);
        int[] nonZeroElements = nonZeroIndexes.elements();

        // specialized for speed
        if (function == DoubleFunctions.mult) { // x[i] = x[i] * y[i]
            int j = 0;
    ...
    public boolean equals(Object obj) {
        ...
        return com.cern.colt.matrix.tdouble.algo.DoubleProperty.DEFAULT.equals(this, (DoubleMatrix1D) obj);
    }
     ...
     * @return the new view.
     */
    public DoubleMatrix1D viewSelection(com.cern.colt.function.tdouble.DoubleProcedure condition) {
     ...
     * information, see
     * {@link com.cern.colt.matrix.tdouble.algo.DoubleSorting#sort(DoubleMatrix1D)}.
    ...
    public DoubleMatrix1D viewSorted() {
        return com.cern.colt.matrix.tdouble.algo.DoubleSorting.mergeSort.sort(this);
    }
