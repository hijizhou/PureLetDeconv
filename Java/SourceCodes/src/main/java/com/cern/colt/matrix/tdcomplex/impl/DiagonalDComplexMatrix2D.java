...
public class DiagonalDComplexMatrix2D extends WrapperDComplexMatrix2D {
                ...
                for (int j = 0; j < nthreads; j++) {
                    ...
                    futures[j] = ConcurrencyUtils.submit(new Runnable() {
                        ...
                        public void run() {
                            ...
                            } else if (function == com.cern.jet.math.tdcomplex.DComplexFunctions.mult) { // x[i] = x[i] * y[i]
                                double[] elem = new double[2];
                            ...
                            } else if (function == com.cern.jet.math.tdcomplex.DComplexFunctions.div) { // x[i] = x[i] /  y[i]
                                double[] elem = new double[2];
                                double[] otherElem = new double[2];
                                for (int j = firstIdx; j < lastIdx; j++) {
                                    otherElem[0] = otherElements[2 * j];
    ...
    public boolean equals(double[] value) {
        double epsilon = com.cern.colt.matrix.tdcomplex.algo.DComplexProperty.DEFAULT.tolerance();
