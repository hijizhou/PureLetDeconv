 ...
 */
package com.cern.colt.matrix.tdcomplex.impl;
...
import com.edu.emory.mathcs.csparsej.tdcomplex.DZcs_transpose;
...
public class SparseCCDComplexMatrix2D extends WrapperDComplexMatrix2D {
    ...
    public DComplexMatrix2D assign(final com.cern.colt.function.tdcomplex.DComplexDComplexFunction function) {
        if (function instanceof com.cern.jet.math.tdcomplex.DComplexMult) { // x[i] = mult*x[i]
            final double[] alpha = ((com.cern.jet.math.tdcomplex.DComplexMult) function).multiplicator;
            ...
            forEachNonZero(new com.cern.colt.function.tdcomplex.IntIntDComplexFunction() {
    ...
    public DComplexMatrix2D assign(DComplexMatrix2D source) {
        ...
        if (source instanceof SparseCCDComplexMatrix2D) {
            ...
            assign(0, 0);
            source.forEachNonZero(new com.cern.colt.function.tdcomplex.IntIntDComplexFunction() {
                public double[] apply(int i, int j, double[] value) {
                    setQuick(i, j, value);
                    return value;
                }
    ...
    public DComplexMatrix2D assign(final DComplexMatrix2D y,
            com.cern.colt.function.tdcomplex.DComplexDComplexDComplexFunction function) {
        checkShape(y);

        if ((y instanceof SparseCCDComplexMatrix2D) && (function == com.cern.jet.math.tdcomplex.DComplexFunctions.plus)) { // x[i] = x[i] + y[i]
        ...
        if (function instanceof com.cern.jet.math.tdcomplex.DComplexPlusMultSecond) { // x[i] = x[i] + alpha*y[i]
            final double[] alpha = ((com.cern.jet.math.tdcomplex.DComplexPlusMultSecond) function).multiplicator;
            if (alpha[0] == 0 && alpha[1] == 0)
                return this; // nothing to do
            y.forEachNonZero(new com.cern.colt.function.tdcomplex.IntIntDComplexFunction() {
                public double[] apply(int i, int j, double[] value) {
        ...
        if (function instanceof com.cern.jet.math.tdcomplex.DComplexPlusMultFirst) { // x[i] = alpha*x[i] + y[i]
            final double[] alpha = ((com.cern.jet.math.tdcomplex.DComplexPlusMultFirst) function).multiplicator;
            if (alpha[0] == 0 && alpha[1] == 0)
                return assign(y);
            y.forEachNonZero(new com.cern.colt.function.tdcomplex.IntIntDComplexFunction() {
                public double[] apply(int i, int j, double[] value) {
        ...
        if (function == com.cern.jet.math.tdcomplex.DComplexFunctions.mult) { // x[i] = x[i] * y[i]
        ...
        if (function == com.cern.jet.math.tdcomplex.DComplexFunctions.div) { // x[i] = x[i] / y[i]
            final int[] rowIndexesA = rowIndexes;
            final int[] columnPointersA = columnPointers;
            final double[] valuesA = values;
    ...
    public DComplexMatrix2D forEachNonZero(final com.cern.colt.function.tdcomplex.IntIntDComplexFunction function) {
        final int[] rowIndexesA = rowIndexes;
        final int[] columnPointersA = columnPointers;
        final double[] valuesA = values;
        double[] valA = new double[2];
    ...
    public DComplexMatrix1D zMult(DComplexMatrix1D y, DComplexMatrix1D z, final double[] alpha, final double[] beta,
        ...
        if (!transposeA) {
            if ((!ignore) && !(beta[0] == 1 && beta[1] == 0)) {
                z.assign(com.cern.jet.math.tdcomplex.DComplexFunctions.mult(beta));
            }
    ...
    public DComplexMatrix2D zMult(DComplexMatrix2D B, DComplexMatrix2D C, final double[] alpha, double[] beta,
        ...
        if (!ignore && !(beta[0] == 1 && beta[1] == 0)) {
            C.assign(com.cern.jet.math.tdcomplex.DComplexFunctions.mult(beta));
        }
        ...
        if ((B instanceof DenseDComplexMatrix2D) && (C instanceof DenseDComplexMatrix2D)) {
            ...
            if (!(alpha[0] == 1.0 && alpha[1] == 0)) {
                C.assign(com.cern.jet.math.tdcomplex.DComplexFunctions.mult(alpha));
            }
            ...
            Cp[n] = nz; /* finalize the last column of C */
            if (!(alpha[0] == 1.0 && alpha[1] == 0)) {
                CC.assign(com.cern.jet.math.tdcomplex.DComplexFunctions.mult(alpha));
            }
        } else {
            if (transposeB) {
            ...
            final com.cern.jet.math.tdcomplex.DComplexPlusMultSecond fun = com.cern.jet.math.tdcomplex.DComplexPlusMultSecond
