...
import com.cern.colt.matrix.tfloat.FloatMatrix2DProcedure;
import com.cern.colt.matrix.tfloat.FloatMatrix3D;
import com.cern.colt.matrix.tfloat.FloatMatrix3DProcedure;
...
public class FloatStencil extends Object {
     ...
     */
    public static int stencil27(FloatMatrix3D A, com.cern.colt.function.tfloat.Float27Function function, int maxIterations,
     ...
     * @return the number of iterations actually executed.
     */
    public static int stencil9(FloatMatrix2D A, com.cern.colt.function.tfloat.Float9Function function, int maxIterations,
