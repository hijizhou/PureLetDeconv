 ...
 */
package com.cern.colt.matrix.tfloat;
...
public abstract class FloatMatrix2D extends AbstractMatrix2D {
     ...
     * @see FloatFunctions
     */
    public FloatMatrix2D assign(final com.cern.colt.function.tfloat.FloatFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (rows * columns >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
            Future<?>[] futures = new Future[nthreads];
    ...
    public boolean equals(float value) {
        return com.cern.colt.matrix.tfloat.algo.FloatProperty.DEFAULT.equals(this, value);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return com.cern.colt.matrix.tfloat.algo.FloatProperty.DEFAULT.equals(this, (FloatMatrix2D) obj);
    }
     ...
     * 
     * @see com.cern.colt.matrix.tfloat.algo.FloatFormatter
     */

    public String toString() {
        return new com.cern.colt.matrix.tfloat.algo.FloatFormatter().toString(this);
    }
     ...
     * {@link com.cern.colt.matrix.tfloat.algo.FloatSorting#sort(FloatMatrix2D,int)}
     * . For more advanced sorting functionality, see
     * {@link com.cern.colt.matrix.tfloat.algo.FloatSorting}.
     * 
    ...
    public FloatMatrix2D viewSorted(int column) {
        return com.cern.colt.matrix.tfloat.algo.FloatSorting.mergeSort.sort(this, column);
    }
     ...
     * com.cern.colt.function.Float9Function f = new
     * com.cern.colt.function.Float9Function() {    public final
     ...
     * neighbors com.cern.colt.function.Float9Function g = new
     * com.cern.colt.function.Float9Function() {    public final
     * float apply(       float a00, float a01,
     * float a02,       float a10, float a11,
     * float a12,       float a20, float a21,
