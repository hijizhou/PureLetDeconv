 ...
 */
public class BitVector extends com.cern.colt.PersistentObject {
    /*
    ...
    private class IndexProcedure implements com.cern.colt.function.tint.IntProcedure {
    ...
    public boolean forEachIndexFromToInState(int from, int to, boolean state,
            com.cern.colt.function.tint.IntProcedure procedure) {
        /*
