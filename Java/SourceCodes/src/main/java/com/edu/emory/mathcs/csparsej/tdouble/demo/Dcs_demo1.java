...
import com.edu.emory.mathcs.csparsej.tdouble.Dcs_entry;
...
import com.edu.emory.mathcs.csparsej.tdouble.Dcs_print;
...
public class Dcs_demo1 {
    public static void main(String[] args) {
        ...
        int i, m;
        if (args.length == 0) {
            throw new IllegalArgumentException("Usage: java com.edu.emory.mathcs.csparsej.tdouble.demo.Dcs_demo1 fileName");
        }
