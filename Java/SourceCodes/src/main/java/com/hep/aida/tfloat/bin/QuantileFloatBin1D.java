...
import com.cern.jet.stat.tfloat.quantile.FloatQuantileFinder;
import com.cern.jet.stat.tfloat.quantile.FloatQuantileFinderFactory;
 ...
 * </center>
 * 
 * @see com.cern.jet.stat.tfloat.quantile
...
public class QuantileFloatBin1D extends MightyStaticFloatBin1D {
    ...
    public QuantileFloatBin1D(float epsilon) {
        this(false, Long.MAX_VALUE, epsilon, 0.001f, 10000, new com.cern.jet.random.tfloat.engine.FRand(
                new java.util.Date()));
    }
     ...
     *            the desired number of subintervals per interval.
     */
    public synchronized MightyStaticFloatBin1D[] splitApproximately(com.hep.aida.tfloat.FloatIAxis axis, int k) {
        FloatArrayList percentages = new FloatArrayList(new com.hep.aida.tfloat.ref.FloatConverter().edges(axis));
