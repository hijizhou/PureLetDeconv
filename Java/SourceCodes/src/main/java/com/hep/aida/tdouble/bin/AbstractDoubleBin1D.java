...
public abstract class AbstractDoubleBin1D extends AbstractDoubleBin implements
        com.cern.colt.buffer.tdouble.DoubleBufferConsumer {
    /**
     * 
     */
     ...
     */
    public synchronized com.cern.colt.buffer.tdouble.DoubleBuffer buffered(int capacity) {
        return new com.cern.colt.buffer.tdouble.DoubleBuffer(this, capacity);
    }
