...
public abstract class AbstractFloatBin1D extends AbstractFloatBin implements
        com.cern.colt.buffer.tfloat.FloatBufferConsumer {
    /**
     * 
     */
     ...
     */
    public synchronized com.cern.colt.buffer.tfloat.FloatBuffer buffered(int capacity) {
        return new com.cern.colt.buffer.tfloat.FloatBuffer(this, capacity);
    }
