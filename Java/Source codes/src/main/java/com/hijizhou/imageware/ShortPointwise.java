	...
	*/
	...
	public void invert() {
		...
		for(int z=0; z<nz; z++) {
			slice = (short[])data[z];
			for(int k=0; k<nxy; k++) {
				slice[k] = (short)(max-(slice[k] & 0xFFFF));
			}
		}
	}
	...
	*/
	...
	public void rescale() {
		...
		for(int z=0; z<nz; z++) {
			slice = (short[])data[z];
			for(int k=0; k<nxy; k++) {
				slice[k] = (short)(a*((slice[k] & 0xFFFF)-minImage));
			}
		}
	}
	...
	*/
	...
	public void rescale(double minLevel, double maxLevel) {
		...
		for(int z=0; z<nz; z++) {
			slice = (short[])data[z];
			for(int k=0; k<nxy; k++) {
				slice[k] = (short)(a*((slice[k] & 0xFFFF)-minImage) + minLevel);
			}
		}
	}
	...
	*/
	...
	public void rescaleCenter(double minLevel, double maxLevel) {
		...
		for(int z=0; z<nz; z++) {
			slice = (short[])data[z];
			for(int k=0; k<nxy; k++) {
				slice[k] = (short)(a*((slice[k] & 0xFFFF)-minImage) + center);
			}
		}
	}
