 ...
 */
package com.cern.jet.stat.tdouble;
...
public class DoubleDescriptive extends Object {
     ...
     * <tt>b(k,i) = </tt>
     * {@link com.cern.jet.math.tdouble.DoubleArithmetic#binomial(long,long)
     * binomial(k,i)} and <br>
    ...
    public static double moment(int k, double c, int size, double[] sumOfPowers) {
        ...
        for (int i = 0; i <= k; i++) {
            ...
            if (i == 0)
                ...
                y = Math.pow(c, i);
            // sum += sign *
            sum += sign * com.cern.jet.math.tdouble.DoubleArithmetic.binomial(k, i) * y * sumOfPowers[k - i];
            sign = -sign;
        }
        /*
