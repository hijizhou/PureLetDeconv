...
public class DoubleQuantileFinderFactory extends Object {
     ...
     */
    public static com.cern.colt.list.tdouble.DoubleArrayList newEquiDepthPhis(int quantiles) {
        com.cern.colt.list.tdouble.DoubleArrayList phis = new com.cern.colt.list.tdouble.DoubleArrayList(quantiles - 1);
