...
import com.cern.jet.math.tfloat.FloatArithmetic;
...
public class FloatQuantileFinderFactory extends Object {
     ...
     */
    public static com.cern.colt.list.tfloat.FloatArrayList newEquiDepthPhis(int quantiles) {
        com.cern.colt.list.tfloat.FloatArrayList phis = new com.cern.colt.list.tfloat.FloatArrayList(quantiles - 1);
