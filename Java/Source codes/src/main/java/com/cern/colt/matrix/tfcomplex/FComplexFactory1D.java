...
import com.cern.colt.matrix.tfcomplex.impl.SparseFComplexMatrix1D;
 ...
 */
public class FComplexFactory1D extends com.cern.colt.PersistentObject {
    ...
    public FComplexMatrix1D random(int size) {
        return make(size).assign(com.cern.jet.math.tfcomplex.FComplexFunctions.random());
    }
