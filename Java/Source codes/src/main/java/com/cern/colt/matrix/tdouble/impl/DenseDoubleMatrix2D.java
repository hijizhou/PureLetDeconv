...
import com.org.jtransforms.dct.DoubleDCT_2D;
import com.org.jtransforms.dht.DoubleDHT_2D;
import com.org.jtransforms.dst.DoubleDST_2D;
...
public class DenseDoubleMatrix2D extends DoubleMatrix2D {
    ...
    public DoubleMatrix2D assign(final com.cern.colt.function.tdouble.DoubleFunction function) {
        ...
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size() >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            if (function instanceof com.cern.jet.math.tdouble.DoubleMult) { // x[i] =
                // mult*x[i]
                double multiplicator = ((com.cern.jet.math.tdouble.DoubleMult) function).multiplicator;
                if (multiplicator == 1)
                    return this;
                if (multiplicator == 0)
                    return assign(0);
            ...
            for (int j = 0; j < nthreads; j++) {
                ...
                futures[j] = ConcurrencyUtils.submit(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (function instanceof com.cern.jet.math.tdouble.DoubleMult) {
                            // x[i] = mult*x[i]
                            double multiplicator = ((com.cern.jet.math.tdouble.DoubleMult) function).multiplicator;
                            if (multiplicator == 1)
                                return;
    ...
    public DoubleMatrix2D assign(final com.cern.colt.function.tdouble.DoubleProcedure cond,
            final com.cern.colt.function.tdouble.DoubleFunction function) {
        final int zero = (int) index(0, 0);
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size() >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
    ...
    public DoubleMatrix2D assign(final DoubleMatrix2D y, final com.cern.colt.function.tdouble.DoubleDoubleFunction function) {
        ...
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size() >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            if (function instanceof com.cern.jet.math.tdouble.DoublePlusMultSecond) {
                double multiplicator = ((com.cern.jet.math.tdouble.DoublePlusMultSecond) function).multiplicator;
            ...
            for (int j = 0; j < nthreads; j++) {
                ...
                futures[j] = ConcurrencyUtils.submit(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (function == com.cern.jet.math.tdouble.DoubleFunctions.mult) {
                            // x[i] = x[i]*y[i]
                        ...
                        } else if (function == com.cern.jet.math.tdouble.DoubleFunctions.div) {
                            // x[i] = x[i] / y[i]
                            idx = zero + firstRow * rowStride;
                            idxOther = zeroOther + firstRow * rowStrideOther;
                            for (int r = firstRow; r < lastRow; r++) {
                        ...
                        } else if (function instanceof com.cern.jet.math.tdouble.DoublePlusMultSecond) {
                            double multiplicator = ((com.cern.jet.math.tdouble.DoublePlusMultSecond) function).multiplicator;
                            if (multiplicator == 1) {
                                // x[i] = x[i] + y[i]
                                idx = zero + firstRow * rowStride;
