 ...
 */
package com.cern.colt.list.tint;
 ...
 * picture.
 */
public abstract class AbstractIntList extends AbstractList implements com.cern.colt.buffer.tint.IntBufferConsumer {
    /**
     * 
     */
    ...
    public void shuffleFromTo(int from, int to) {
        ...
        com.cern.jet.random.tdouble.DoubleUniform gen = new com.cern.jet.random.tdouble.DoubleUniform(
                new com.cern.jet.random.tdouble.engine.DRand(new java.util.Date()));
        for (int i = from; i < to; i++) {
