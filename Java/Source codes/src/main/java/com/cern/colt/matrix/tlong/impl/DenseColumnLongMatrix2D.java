...
import com.cern.colt.function.tlong.LongFunction;
import com.cern.colt.function.tlong.LongLongFunction;
import com.cern.colt.function.tlong.LongProcedure;
...
public class DenseColumnLongMatrix2D extends LongMatrix2D {
    ...
    public LongMatrix2D assign(final LongMatrix2D y, final LongLongFunction function) {
        ...
        if (function instanceof com.cern.jet.math.tlong.LongPlusMultFirst) {
