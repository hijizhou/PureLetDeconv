...
public abstract class LongMatrix3D extends AbstractMatrix3D {
     ...
     */
    public long aggregate(final com.cern.colt.function.tlong.LongLongFunction aggr,
            final com.cern.colt.function.tlong.LongFunction f, final IntArrayList sliceList, final IntArrayList rowList,
     ...
     * @see com.cern.jet.math.tlong.LongFunctions
     */
    public long aggregate(final LongMatrix3D other, final com.cern.colt.function.tlong.LongLongFunction aggr,
     ...
     * @see com.cern.jet.math.tlong.LongFunctions
     */
    public LongMatrix3D assign(final com.cern.colt.function.tlong.LongFunction function) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (slices * rows * columns >= ConcurrencyUtils.getThreadsBeginN_3D())) {
            nthreads = Math.min(nthreads, slices);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see com.cern.jet.math.tlong.LongFunctions
     */
    public LongMatrix3D assign(final com.cern.colt.function.tlong.LongProcedure cond,
            final com.cern.colt.function.tlong.LongFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (slices * rows * columns >= ConcurrencyUtils.getThreadsBeginN_3D())) {
            nthreads = Math.min(nthreads, slices);
     ...
     * 
     */
    public LongMatrix3D assign(final com.cern.colt.function.tlong.LongProcedure cond, final long value) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (slices * rows * columns >= ConcurrencyUtils.getThreadsBeginN_3D())) {
            nthreads = Math.min(nthreads, slices);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see com.cern.jet.math.tlong.LongFunctions
     */
    public LongMatrix3D assign(final LongMatrix3D y, final com.cern.colt.function.tlong.LongLongFunction function) {
        checkShape(y);
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (slices * rows * columns >= ConcurrencyUtils.getThreadsBeginN_3D())) {
            nthreads = Math.min(nthreads, slices);
    ...
    public boolean equals(Object obj) {
        ...
        return com.cern.colt.matrix.tlong.algo.LongProperty.DEFAULT.equals(this, (LongMatrix3D) obj);
    }
     ...
     * information, see
     * {@link com.cern.colt.matrix.tlong.algo.LongSorting#sort(LongMatrix3D,int,int)}
    ...
    public LongMatrix3D viewSorted(int row, int column) {
        return com.cern.colt.matrix.tlong.algo.LongSorting.mergeSort.sort(this, row, column);
    }
