...
import com.cern.colt.matrix.tint.impl.DenseIntMatrix2D;
...
public abstract class IntMatrix2D extends AbstractMatrix2D {
    ...
    public int aggregate(final com.cern.colt.function.tint.IntIntFunction aggr,
            final com.cern.colt.function.tint.IntFunction f, final com.cern.colt.function.tint.IntProcedure cond) {
        if (size() == 0)
            throw new IllegalArgumentException("size == 0");
        int a = 0;
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
     ...
     */
    public int aggregate(final com.cern.colt.function.tint.IntIntFunction aggr,
            final com.cern.colt.function.tint.IntFunction f, final IntArrayList rowList, final IntArrayList columnList) {
        if (size() == 0)
            throw new IllegalArgumentException("size == 0");
     ...
     * @see com.cern.jet.math.tint.IntFunctions
     */
    public int aggregate(final IntMatrix2D other, final com.cern.colt.function.tint.IntIntFunction aggr,
     ...
     * @see com.cern.jet.math.tint.IntFunctions
     */
    public IntMatrix2D assign(final com.cern.colt.function.tint.IntFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (rows * columns >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see com.cern.jet.math.tint.IntFunctions
     */
    public IntMatrix2D assign(final com.cern.colt.function.tint.IntProcedure cond,
     ...
     * 
     */
    public IntMatrix2D assign(final com.cern.colt.function.tint.IntProcedure cond, final int value) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (rows * columns >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see com.cern.jet.math.tint.IntFunctions
     */
    public IntMatrix2D assign(final IntMatrix2D y, final com.cern.colt.function.tint.IntIntFunction function) {
        checkShape(y);
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (rows * columns >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            nthreads = Math.min(nthreads, rows);
    ...
    public boolean equals(Object obj) {
        ...
        return com.cern.colt.matrix.tint.algo.IntProperty.DEFAULT.equals(this, (IntMatrix2D) obj);
    }
     ...
     * {@link com.cern.colt.matrix.tint.algo.IntSorting#sort(IntMatrix2D,int)}. For
    ...
    public IntMatrix2D viewSorted(int column) {
        return com.cern.colt.matrix.tint.algo.IntSorting.mergeSort.sort(this, column);
    }
