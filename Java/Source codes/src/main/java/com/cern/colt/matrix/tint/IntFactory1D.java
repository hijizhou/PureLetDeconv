...
import com.cern.colt.matrix.tint.impl.SparseIntMatrix1D;
 ...
 */
public class IntFactory1D extends com.cern.colt.PersistentObject {
    /**
     * 
     */
     ...
     * @return a new matrix.
     */
    public IntMatrix1D make(com.cern.colt.list.tint.AbstractIntList values) {
    ...
    public IntMatrix1D random(int size) {
        return make(size).assign(IntFunctions.random());
    }
     ...
     * @return a new list.
     */
    public com.cern.colt.list.tint.IntArrayList toList(IntMatrix1D values) {
        int size = (int) values.size();
        com.cern.colt.list.tint.IntArrayList list = new com.cern.colt.list.tint.IntArrayList(size);
        list.setSize(size);
        for (int i = size; --i >= 0;)
