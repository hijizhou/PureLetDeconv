...
import com.cern.colt.matrix.tobject.impl.DenseObjectMatrix1D;
import com.cern.colt.matrix.tobject.impl.SparseObjectMatrix1D;
 ...
 */
public class ObjectFactory1D extends com.cern.colt.PersistentObject {
    /**
     * 
     */
     ...
     * @return a new matrix.
     */
    public ObjectMatrix1D make(com.cern.colt.list.tobject.ObjectArrayList values) {
     ...
     * @return a new list.
     */
    public com.cern.colt.list.tobject.ObjectArrayList toList(ObjectMatrix1D values) {
        int size = (int) values.size();
        com.cern.colt.list.tobject.ObjectArrayList list = new com.cern.colt.list.tobject.ObjectArrayList(size);
        list.setSize(size);
        for (int i = size; --i >= 0;)
