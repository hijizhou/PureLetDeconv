...
public abstract class IntMatrix3D extends AbstractMatrix3D {
     ...
     */
    public int aggregate(final com.cern.colt.function.tint.IntIntFunction aggr,
            final com.cern.colt.function.tint.IntFunction f, final IntArrayList sliceList, final IntArrayList rowList,
     ...
     * @see com.cern.jet.math.tint.IntFunctions
     */
    public int aggregate(final IntMatrix3D other, final com.cern.colt.function.tint.IntIntFunction aggr,
     ...
     * @see com.cern.jet.math.tint.IntFunctions
     */
    public IntMatrix3D assign(final com.cern.colt.function.tint.IntFunction function) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (slices * rows * columns >= ConcurrencyUtils.getThreadsBeginN_3D())) {
            nthreads = Math.min(nthreads, slices);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see com.cern.jet.math.tint.IntFunctions
     */
    public IntMatrix3D assign(final com.cern.colt.function.tint.IntProcedure cond,
     ...
     * 
     */
    public IntMatrix3D assign(final com.cern.colt.function.tint.IntProcedure cond, final int value) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (slices * rows * columns >= ConcurrencyUtils.getThreadsBeginN_3D())) {
            nthreads = Math.min(nthreads, slices);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see com.cern.jet.math.tint.IntFunctions
     */
    public IntMatrix3D assign(final IntMatrix3D y, final com.cern.colt.function.tint.IntIntFunction function) {
        checkShape(y);
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (slices * rows * columns >= ConcurrencyUtils.getThreadsBeginN_3D())) {
            nthreads = Math.min(nthreads, slices);
    ...
    public boolean equals(Object obj) {
        ...
        return com.cern.colt.matrix.tint.algo.IntProperty.DEFAULT.equals(this, (IntMatrix3D) obj);
    }
     ...
     * information, see
     * {@link com.cern.colt.matrix.tint.algo.IntSorting#sort(IntMatrix3D,int,int)}.
    ...
    public IntMatrix3D viewSorted(int row, int column) {
        return com.cern.colt.matrix.tint.algo.IntSorting.mergeSort.sort(this, row, column);
    }
