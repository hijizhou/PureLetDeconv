...
import com.cern.colt.matrix.tdouble.algo.decomposition.DenseDoubleCholeskyDecomposition;
import com.cern.colt.matrix.tdouble.algo.decomposition.DenseDoubleEigenvalueDecomposition;
import com.cern.colt.matrix.tdouble.algo.decomposition.DenseDoubleLUDecomposition;
import com.cern.colt.matrix.tdouble.algo.decomposition.DenseDoubleQRDecomposition;
import com.cern.colt.matrix.tdouble.algo.decomposition.DenseDoubleSingularValueDecomposition;
 ...
 */
public class DenseDoubleAlgebra extends com.cern.colt.PersistentObject {
     ...
     * Returns sqrt(a^2 + b^2) without under/overflow.
     */
    public static com.cern.colt.function.tdouble.DoubleDoubleFunction hypotFunction() {
        return new com.cern.colt.function.tdouble.DoubleDoubleFunction() {
    ...
    public double normF(DoubleMatrix2D A) {
        if (A.size() == 0)
            return 0;
        return A.aggregate(hypotFunction(), DoubleFunctions.identity);
    }
