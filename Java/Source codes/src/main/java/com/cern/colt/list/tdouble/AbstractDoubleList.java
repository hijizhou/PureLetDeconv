 ...
 */
package com.cern.colt.list.tdouble;

import com.cern.colt.function.tdouble.DoubleComparator;
import com.cern.colt.function.tdouble.DoubleProcedure;
import com.cern.colt.list.AbstractList;
 ...
 * picture.
 */
public abstract class AbstractDoubleList extends AbstractList implements com.cern.colt.buffer.tdouble.DoubleBufferConsumer {
    /**
     * 
     */
    ...
    public void mergeSortFromTo(int from, int to) {
        ...
        com.cern.colt.Sorting.mergeSort(myElements, from, to + 1);
        elements(myElements);
        setSizeRaw(mySize);
    }
    ...
    public void mergeSortFromTo(int from, int to, DoubleComparator c) {
        ...
        double[] myElements = elements();
        com.cern.colt.Sorting.mergeSort(myElements, from, to + 1, c);
        elements(myElements);
        setSizeRaw(mySize);
    }
    ...
    public void quickSortFromTo(int from, int to) {
        ...
        // com.cern.colt.Sorting.mergeSort(myElements, from, to+1); // TODO just for
        // debugging
    ...
    public void quickSortFromTo(int from, int to, DoubleComparator c) {
        ...
        double[] myElements = elements();
        com.cern.colt.Sorting.quickSort(myElements, from, to + 1, c);
        elements(myElements);
        setSizeRaw(mySize);
    }
    ...
    public void shuffleFromTo(int from, int to) {
        ...
        com.cern.jet.random.tdouble.DoubleUniform gen = new com.cern.jet.random.tdouble.DoubleUniform(
    ...
    public String toString() {
        return com.cern.colt.Arrays.toString(partFromTo(0, size() - 1).elements());
    }
}
