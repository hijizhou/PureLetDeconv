...
import com.edu.emory.mathcs.csparsej.tdouble.Dcs_lu;
import com.edu.emory.mathcs.csparsej.tdouble.Dcs_sqr;
import com.edu.emory.mathcs.csparsej.tdouble.Dcs_usolve;
...
public class CSparseDoubleLUDecomposition implements SparseDoubleLUDecomposition {
    ...
    /* (non-Javadoc)
	 * @see com.cern.colt.matrix.tdouble.algo.decomposition.SparseDoubleLUDecomposition#det()
	 */
    public double det() {
        if (!isNonsingular())
    ...
    /* (non-Javadoc)
	 * @see com.cern.colt.matrix.tdouble.algo.decomposition.SparseDoubleLUDecomposition#getL()
	 */
    ...
    /* (non-Javadoc)
	 * @see com.cern.colt.matrix.tdouble.algo.decomposition.SparseDoubleLUDecomposition#getPivot()
	 */
    public int[] getPivot() {
        if (N.pinv == null)
            return null;
    ...
    /* (non-Javadoc)
	 * @see com.cern.colt.matrix.tdouble.algo.decomposition.SparseDoubleLUDecomposition#getU()
	 */
    ...
    /* (non-Javadoc)
	 * @see com.cern.colt.matrix.tdouble.algo.decomposition.SparseDoubleLUDecomposition#getSymbolicAnalysis()
	 */
    ...
    /* (non-Javadoc)
	 * @see com.cern.colt.matrix.tdouble.algo.decomposition.SparseDoubleLUDecomposition#isNonsingular()
	 */
    ...
    /* (non-Javadoc)
	 * @see com.cern.colt.matrix.tdouble.algo.decomposition.SparseDoubleLUDecomposition#solve(com.cern.colt.matrix.tdouble.DoubleMatrix1D)
	 */
