...
import com.cern.colt.matrix.tfcomplex.impl.SparseFComplexMatrix3D;
 ...
 */
public class FComplexFactory3D extends com.cern.colt.PersistentObject {
    ...
    public FComplexMatrix3D random(int slices, int rows, int columns) {
        return make(slices, rows, columns).assign(com.cern.jet.math.tfcomplex.FComplexFunctions.random());
    }
}
