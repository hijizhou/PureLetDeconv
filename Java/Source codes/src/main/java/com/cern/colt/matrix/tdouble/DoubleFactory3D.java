...
import com.cern.colt.matrix.tdouble.impl.SparseDoubleMatrix3D;
 ...
 */
public class DoubleFactory3D extends com.cern.colt.PersistentObject {
    ...
    public DoubleMatrix3D random(int slices, int rows, int columns) {
        return make(slices, rows, columns).assign(DoubleFunctions.random());
    }
}
