 ...
 */
package com.cern.colt;

import java.util.Comparator;

import com.cern.colt.function.tbyte.ByteComparator;
import com.cern.colt.function.tchar.CharComparator;
...
import com.cern.colt.function.tshort.ShortComparator;
 ...
 * 
 * @see GenericSorting
 * @see com.cern.colt.matrix.tdouble.algo.DoubleSorting
...
public class Sorting extends Object {
    ...
    private static void mergeSort2(double a[], int fromIndex, int toIndex) {
        ...
        if (numNegZeros != 0) {
            int j = new com.cern.colt.list.tdouble.DoubleArrayList(a).binarySearchFromTo(0.0d, fromIndex, n - 1); // posn
            // of
            // ANY
            // zero
            do {
    ...
    private static void mergeSort2(float a[], int fromIndex, int toIndex) {
        ...
        // Postprocessing phase: change 0.0's to -0.0's as required
        if (numNegZeros != 0) {
            int j = new com.cern.colt.list.tfloat.FloatArrayList(a).binarySearchFromTo(0.0f, fromIndex, n - 1); // posn
            // of
            // ANY
            // zero
            do {
