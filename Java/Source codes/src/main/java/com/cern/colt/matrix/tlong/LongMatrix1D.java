 ...
 */
package com.cern.colt.matrix.tlong;
...
import com.cern.colt.list.tlong.LongArrayList;
...
public abstract class LongMatrix1D extends AbstractMatrix1D {
     ...
     * @see com.cern.jet.math.tlong.LongFunctions
     */
    public long aggregate(final com.cern.colt.function.tlong.LongLongFunction aggr,
            final com.cern.colt.function.tlong.LongFunction f) {
        if (size == 0)
     ...
     */
    public long aggregate(final com.cern.colt.function.tlong.LongLongFunction aggr,
            final com.cern.colt.function.tlong.LongFunction f, final IntArrayList indexList) {
        if (size() == 0)
            throw new IllegalArgumentException("size == 0");
     ...
     * @see com.cern.jet.math.tlong.LongFunctions
     */
    public long aggregate(final LongMatrix1D other, final com.cern.colt.function.tlong.LongLongFunction aggr,
            final com.cern.colt.function.tlong.LongLongFunction f) {
        checkSize(other);
        if (size == 0)
            throw new IllegalArgumentException("size == 0");
     ...
     * @see com.cern.jet.math.tlong.LongFunctions
     */
    public LongMatrix1D assign(final com.cern.colt.function.tlong.LongFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see com.cern.jet.math.tlong.LongFunctions
     */
    public LongMatrix1D assign(final com.cern.colt.function.tlong.LongProcedure cond,
            final com.cern.colt.function.tlong.LongFunction f) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
     ...
     * 
     */
    public LongMatrix1D assign(final com.cern.colt.function.tlong.LongProcedure cond, final long value) {
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
            Future<?>[] futures = new Future[nthreads];
     ...
     * @see com.cern.jet.math.tlong.LongFunctions
     */
    public LongMatrix1D assign(final LongMatrix1D y, final com.cern.colt.function.tlong.LongLongFunction function) {
        checkSize(y);
        int nthreads = ConcurrencyUtils.getNumberOfThreads();
        if ((nthreads > 1) && (size >= ConcurrencyUtils.getThreadsBeginN_1D())) {
            nthreads = Math.min(nthreads, size);
     ...
     * @see com.cern.jet.math.tlong.LongFunctions
     */
    public LongMatrix1D assign(LongMatrix1D y, com.cern.colt.function.tlong.LongLongFunction function,
            IntArrayList nonZeroIndexes) {
        checkSize(y);
        int[] nonZeroElements = nonZeroIndexes.elements();

        // specialized for speed
        if (function == com.cern.jet.math.tlong.LongFunctions.mult) { // x[i] = x[i] *
            // y[i]
            int j = 0;
        ...
        } else if (function instanceof com.cern.jet.math.tlong.LongPlusMultSecond) {
            long multiplicator = ((com.cern.jet.math.tlong.LongPlusMultSecond) function).multiplicator;
    ...
    public boolean equals(long value) {
        return com.cern.colt.matrix.tlong.algo.LongProperty.DEFAULT.equals(this, value);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return com.cern.colt.matrix.tlong.algo.LongProperty.DEFAULT.equals(this, (LongMatrix1D) obj);
    }
     ...
     * 
     * @see com.cern.colt.matrix.tlong.algo.LongFormatter
     */

    public String toString() {
        return new com.cern.colt.matrix.tlong.algo.LongFormatter().toString(this);
    }
     ...
     * @return the new view.
     */
    public LongMatrix1D viewSelection(com.cern.colt.function.tlong.LongProcedure condition) {
     ...
     * information, see
     * {@link com.cern.colt.matrix.tlong.algo.LongSorting#sort(LongMatrix1D)}. For
     * more advanced sorting functionality, see
     * {@link com.cern.colt.matrix.tlong.algo.LongSorting}.
     * 
     * @return a new sorted vector (matrix) view.
     */
    public LongMatrix1D viewSorted() {
        return com.cern.colt.matrix.tlong.algo.LongSorting.mergeSort.sort(this);
    }
    ...
    public long zSum() {
        if (size() == 0)
            return 0;
        return aggregate(com.cern.jet.math.tlong.LongFunctions.plus, com.cern.jet.math.tlong.LongFunctions.identity);
    }
}
