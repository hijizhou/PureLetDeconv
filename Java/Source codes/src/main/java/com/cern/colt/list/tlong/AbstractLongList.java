 ...
 */
package com.cern.colt.list.tlong;

import com.cern.colt.function.tlong.LongComparator;
...
public abstract class AbstractLongList extends AbstractList {
    ...
    public void quickSortFromTo(int from, int to) {
        ...
        long[] myElements = elements();
        com.cern.colt.Sorting.parallelQuickSort(myElements, from, to + 1, new LongComparator() {
    ...
    public void quickSortFromTo(int from, int to, LongComparator c) {
        ...
        long[] myElements = elements();
        com.cern.colt.Sorting.parallelQuickSort(myElements, from, to + 1, c);
        elements(myElements);
        setSizeRaw(mySize);
    }
