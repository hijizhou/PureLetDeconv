...
import com.cern.jet.stat.tdouble.quantile.DoubleQuantileFinder;
import com.cern.jet.stat.tdouble.quantile.DoubleQuantileFinderFactory;
 ...
 * </center>
 * 
 * @see com.cern.jet.stat.tdouble.quantile
...
public class QuantileDoubleBin1D extends MightyStaticDoubleBin1D {
    ...
    /**
     * Equivalent to
     * <tt>new QuantileBin1D(false, Long.MAX_VALUE, epsilon, 0.001, 10000, new com.cern.jet.random.engine.DRand(new java.util.Date())</tt>
     * .
     */
    public QuantileDoubleBin1D(double epsilon) {
        this(false, Long.MAX_VALUE, epsilon, 0.001, 10000, new com.cern.jet.random.tdouble.engine.DRand(
                new java.util.Date()));
    }
     ...
     *            the desired number of subintervals per interval.
     */
    public synchronized MightyStaticDoubleBin1D[] splitApproximately(com.hep.aida.tdouble.DoubleIAxis axis, int k) {
        DoubleArrayList percentages = new DoubleArrayList(new com.hep.aida.tdouble.ref.DoubleConverter().edges(axis));
