...
package com.edu.emory.mathcs.csparsej.tdouble;

import com.edu.emory.mathcs.csparsej.tdouble.*;
...
import com.edu.emory.mathcs.csparsej.tdouble.Dcs_qr;
...
public class Dcs_qrsol {
    ...
    public static boolean cs_qrsol(int order, Dcs A, double[] b) {
        ...
        m = A.m;
        if (m >= n) {
            S = com.edu.emory.mathcs.csparsej.tdouble.Dcs_sqr.cs_sqr(order, A, true); /* ordering and symbolic analysis */
            N = com.edu.emory.mathcs.csparsej.tdouble.Dcs_qr.cs_qr(A, S); /* numeric QR factorization */
            x = new double[S != null ? S.m2 : 1]; /* get workspace */
            ok = (S != null && N != null);
            if (ok) {
                com.edu.emory.mathcs.csparsej.tdouble.Dcs_ipvec.cs_ipvec(S.pinv, b, x, m); /* x(0:m-1) = b(p(0:m-1) */
            ...
            if (ok) {
                com.edu.emory.mathcs.csparsej.tdouble.Dcs_pvec.cs_pvec(S.q, b, x, m); /* x(q(0:m-1)) = b(0:m-1) */
